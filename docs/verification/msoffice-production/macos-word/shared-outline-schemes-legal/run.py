...
for scheme in ['chinese-formal','hybrid-bid']:
 ...
 d=generate(str(md),format='docx',output=str(root/(scheme+'.docx')),engine='msoffice',timeout=180)
 p=convert_to_pdf(d,output=str(root/(scheme+'.pdf')),engine='msoffice',timeout=90)
