...
root=Path('build/msoffice-production/sentinel-01').resolve();root.mkdir(exist_ok=False)
...
try:
    ...
    commands=[['representative-01','fixtures/verify_msoffice_production.py','--output-root','build/msoffice-production/representative-01','--fixture','representative','--engine','msoffice','--timeout','600'],['public-pdf-01','build/msoffice-production/public_pdf.py']]
    report['runs']=[]
