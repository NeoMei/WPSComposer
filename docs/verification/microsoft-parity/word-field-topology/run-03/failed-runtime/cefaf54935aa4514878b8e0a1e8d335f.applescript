...
if not (exists bookmark "WPSC_F_5396aa1766004a0494d51f990b1861" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_5396aa1766004a0494d51f990b1861" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_5396aa1766004a0494d51f990b1861",start of content of identityRange}
if not (exists bookmark "WPSC_R_975cd0d09a7f4224b4c75ddcad1642" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_975cd0d09a7f4224b4c75ddcad1642" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_975cd0d09a7f4224b4c75ddcad1642",start of content of identityRange}
