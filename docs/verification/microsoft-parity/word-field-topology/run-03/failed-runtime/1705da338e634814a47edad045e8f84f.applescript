...
set content of semanticRange to "Target paragraph for native reference." & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 39)
