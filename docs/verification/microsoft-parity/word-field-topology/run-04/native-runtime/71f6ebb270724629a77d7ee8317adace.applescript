...
make new bookmark at boundDoc with properties {name:"WPSC_R_11facb38d17b478d973ec096bd4624", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_11facb38d17b478d973ec096bd4624" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",0,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_11facb38d17b478d973ec096bd4624"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
