set pptAlias to POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-5gbd1n6t/native.pptx"
set pptPath to pptAlias as text
set pdfPath to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-5gbd1n6t/native.pdf") as text
with timeout of 40 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-30b13bf0e100461bbd73ddfca18ed1bb"
  ...
  log "PROBE|fill|PASS"
  set pic to make new picture at end of s1 with properties {name:"parity-image", file name:"/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-5gbd1n6t/source.png", link to file:false, save with document:true, left position:280, top:140, width:100, height:90}
  ...
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-30b13bf0e100461bbd73ddfca18ed1bb" then error "Sentinel content changed"
