set pptAlias to POSIX file "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-10/native.pptx"
set pptPath to pptAlias as text
set pdfPath to (POSIX file "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-10/native.pdf") as text
with timeout of 25 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-d0e4813610b84f859e0ae6a09e2c49c7"
  ...
  set imagePath to "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-10/source.png"
  ...
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-d0e4813610b84f859e0ae6a09e2c49c7" then error "Sentinel content changed"
