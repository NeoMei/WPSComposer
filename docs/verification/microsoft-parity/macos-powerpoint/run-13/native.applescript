set pptAlias to POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-762mm716/native-dcd3b9799b744c369f46e9a1db6b658f.pptx"
set pptPath to pptAlias as text
set pdfPath to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-762mm716/native.pdf") as text
with timeout of 35 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-dcd3b9799b744c369f46e9a1db6b658f"
  ...
  log "PROBE|fill|PASS"
  set pic to make new picture at end of s1 with properties {name:"parity-image", file name:"/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-762mm716/source.png", link to file:false, save with document:true, left position:280, top:140, width:100, height:90}
  ...
  set owned to presentation "native-dcd3b9799b744c369f46e9a1db6b658f.pptx"
  log "PROBE|saved_path|" & full name of owned
  if saved of owned is false then error "Save did not mark owned presentation saved"
  if full name of owned does not end with "native-dcd3b9799b744c369f46e9a1db6b658f.pptx" then error "Save did not bind owned output path"
  close owned saving no
  open pptPath
  set owned to presentation "native-dcd3b9799b744c369f46e9a1db6b658f.pptx"
  if full name of owned does not end with "native-dcd3b9799b744c369f46e9a1db6b658f.pptx" then error "Owned reopen identity mismatch"
  ...
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-dcd3b9799b744c369f46e9a1db6b658f" then error "Sentinel content changed"
