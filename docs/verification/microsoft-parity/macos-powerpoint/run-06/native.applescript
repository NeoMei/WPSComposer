with timeout of 30 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-8878920b13eb4c088de9f3dbfb1600eb"
  ...
  set imagePath to "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-06/source.png"
  ...
  save owned in (POSIX file "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-06/native.pptx") as save as Open XML presentation
  ...
  open (POSIX file "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-06/native.pptx")
  ...
  save owned in (POSIX file "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-06/native.pdf") as save as PDF
  log "PROBE|pdf|PASS"
  close owned saving no
  if saved of sentinel then error "Sentinel unexpectedly saved"
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-8878920b13eb4c088de9f3dbfb1600eb" then error "Sentinel content changed"
