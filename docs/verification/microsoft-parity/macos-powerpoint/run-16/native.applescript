set pptAlias to POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nis_fo81/native-b8c2d78a6d464031abcd293bf4d3abd4.pptx"
set pptPath to pptAlias as text
set pdfPath to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nis_fo81/native.pdf") as text
with timeout of 35 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-b8c2d78a6d464031abcd293bf4d3abd4"
  ...
  log "PROBE|fill|PASS"
  set pic to make new picture at end of s1 with properties {name:"parity-image", file name:"/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nis_fo81/source.png", link to file:false, save with document:true, left position:280, top:140, width:100, height:90}
  ...
  set owned to presentation "native-b8c2d78a6d464031abcd293bf4d3abd4.pptx"
  log "PROBE|saved_path|" & full name of owned
  if saved of owned is false then error "Save did not mark owned presentation saved"
  if full name of owned does not end with "native-b8c2d78a6d464031abcd293bf4d3abd4.pptx" then error "Save did not bind owned output path"
  ...
  open "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nis_fo81/native-b8c2d78a6d464031abcd293bf4d3abd4.pptx"
  set owned to presentation "native-b8c2d78a6d464031abcd293bf4d3abd4.pptx"
  if full name of owned does not end with "native-b8c2d78a6d464031abcd293bf4d3abd4.pptx" then error "Owned reopen identity mismatch"
  ...
  close owned saving no
  if saved of sentinel then error "Sentinel unexpectedly saved"
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-b8c2d78a6d464031abcd293bf4d3abd4" then error "Sentinel content changed"
