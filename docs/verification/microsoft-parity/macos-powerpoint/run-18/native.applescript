set pptAlias to POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer-parity-8a7p2hb2/native-9fc0aaad1d814d1dbf7ad14b2756b6df.pptx"
set pptPath to pptAlias as text
set pdfPath to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer-parity-8a7p2hb2/native.pdf") as text
with timeout of 35 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-9fc0aaad1d814d1dbf7ad14b2756b6df"
  ...
  log "PROBE|fill|PASS"
  set pic to make new picture at end of s1 with properties {name:"parity-image", file name:"/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer-parity-8a7p2hb2/source.png", link to file:false, save with document:true, left position:280, top:140, width:100, height:90}
  ...
  set owned to presentation "native-9fc0aaad1d814d1dbf7ad14b2756b6df.pptx"
  log "PROBE|saved_path|" & full name of owned
  if saved of owned is false then error "Save did not mark owned presentation saved"
  if full name of owned does not end with "native-9fc0aaad1d814d1dbf7ad14b2756b6df.pptx" then error "Save did not bind owned output path"
 ...
 tell application "Microsoft PowerPoint"
  open reopenedAlias
  set owned to presentation "native-9fc0aaad1d814d1dbf7ad14b2756b6df.pptx"
  if full name of owned does not end with "native-9fc0aaad1d814d1dbf7ad14b2756b6df.pptx" then error "Owned reopen identity mismatch"
  ...
  close owned saving no
  if saved of sentinel then error "Sentinel unexpectedly saved"
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-9fc0aaad1d814d1dbf7ad14b2756b6df" then error "Sentinel content changed"
  repeat with priorIndex from 1 to (count of beforeState)
   set existing to presentation priorIndex
   if {name of existing, full name of existing, saved of existing, count of slides of existing} is not item priorIndex of beforeState then error "Unrelated presentation changed"
  end repeat
