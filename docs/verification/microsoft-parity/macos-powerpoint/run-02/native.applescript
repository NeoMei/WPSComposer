with timeout of 55 seconds
 tell application "Microsoft PowerPoint"
  ...
  set content of text range of text frame of sentText to "SENTINEL-5c4369e30c744127b965eece089bda75"
  ...
  set pic to make new picture at end of s1 with properties {name:"parity-image", file name:"/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-02/source.png", link to file:false, save with document:true, left position:280, top:140, width:100, height:90}
  ...
  save owned in "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-02/native.pptx" as save as Open XML presentation
  log "PROBE|saved_path|" & full name of owned
  close owned saving no
  open "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-02/native.pptx"
  ...
  save owned in "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-powerpoint/run-02/native.pdf" as save as PDF
  log "PROBE|pdf|PASS"
  close owned saving no
  if saved of sentinel then error "Sentinel unexpectedly saved"
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-5c4369e30c744127b965eece089bda75" then error "Sentinel content changed"
