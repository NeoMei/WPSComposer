set pptAlias to POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nykztsn0/native-e223d59efeda40819efd4510e6af838e.pptx"
set pptPath to pptAlias as text
set pdfPath to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nykztsn0/native.pdf") as text
with timeout of 35 seconds
 tell application "Microsoft PowerPoint"
  set beforeState to {}
  repeat with priorIndex from 1 to (count of presentations)
   set existing to presentation priorIndex
  ...
  set content of text range of text frame of sentText to "SENTINEL-e223d59efeda40819efd4510e6af838e"
  ...
  log "PROBE|fill|PASS"
  set pic to make new picture at end of s1 with properties {name:"parity-image", file name:"/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nykztsn0/source.png", link to file:false, save with document:true, left position:280, top:140, width:100, height:90}
  ...
  set owned to presentation "native-e223d59efeda40819efd4510e6af838e.pptx"
  log "PROBE|saved_path|" & full name of owned
  if saved of owned is false then error "Save did not mark owned presentation saved"
  if full name of owned does not end with "native-e223d59efeda40819efd4510e6af838e.pptx" then error "Save did not bind owned output path"
  ...
  do shell script "/usr/bin/open -b com.microsoft.Powerpoint " & quoted form of "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/tmp/wpscomposer-parity-nykztsn0/native-e223d59efeda40819efd4510e6af838e.pptx"
  set openDeadline to (current date) + 10
  repeat until exists presentation "native-e223d59efeda40819efd4510e6af838e.pptx"
   if (current date) > openDeadline then error "LaunchServices open timed out"
   delay 0.1
  end repeat
  set owned to presentation "native-e223d59efeda40819efd4510e6af838e.pptx"
  if full name of owned does not end with "native-e223d59efeda40819efd4510e6af838e.pptx" then error "Owned reopen identity mismatch"
  ...
  close owned saving no
  if saved of sentinel then error "Sentinel unexpectedly saved"
  if content of text range of text frame of shape 1 of slide 1 of sentinel is not "SENTINEL-e223d59efeda40819efd4510e6af838e" then error "Sentinel content changed"
