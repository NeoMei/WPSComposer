...
set nativeRows to {}
set boundDoc to document "document-2648cb3b0a964e04a101fd335089608c.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-pln07xme/document-2648cb3b0a964e04a101fd335089608c.docx" then error "WPSC_STALE_DOCUMENT"
...
set box to shape 2 of boundDoc
set end of nativeRows to {"textbox", shape type of box is shape type text box, content of text range of text frame of box as text, left position of box, top of box, width of box, height of box, wrap type of wrap format of box is wrap square, font size of font object of text range of text frame of box, bold of font object of text range of text frame of box}
end tell
end timeout
