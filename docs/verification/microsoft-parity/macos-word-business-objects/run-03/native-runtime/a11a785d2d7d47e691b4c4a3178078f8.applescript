...
set nativeRows to {{"created", "shape", shapeIndex, content of text range of text frame of insertedShape as text, left position of insertedShape, top of insertedShape, width of insertedShape, height of insertedShape, my enumIndex(wrap type of wrap format of insertedShape, {wrap square, wrap tight, wrap through, wrap none, wrap top bottom, wrap behind, wrap front, wrap inline})}}
end tell
end timeout
