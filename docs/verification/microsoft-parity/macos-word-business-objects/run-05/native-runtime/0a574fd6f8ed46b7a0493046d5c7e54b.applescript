...
set previousImageCount to count shapes of boundDoc
...
set insertedImage to make new picture at boundDoc with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-e2k8a_fg/image-9e8a36f0924c4f1391e2598bcd20b3f9.png", link to file:false, save with document:true, anchor:imageRange}
...
set nativeRows to {{"created", "shape", imageIndex, previousImageCount, naturalWidth, naturalHeight, width of insertedImage, height of insertedImage, my enumIndex(wrap type of wrap format of insertedImage, {wrap square, wrap tight, wrap through, wrap none, wrap top bottom, wrap behind, wrap front, wrap inline}), (shape type of insertedImage is shape type picture)}}
end tell
end timeout
