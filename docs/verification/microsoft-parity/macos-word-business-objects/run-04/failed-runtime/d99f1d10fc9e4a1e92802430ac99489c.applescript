...
set nativeRows to {}
set boundDoc to document "document-83109f34956e4fcea2a22b1165dd1348.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ekpkjxi4/document-83109f34956e4fcea2a22b1165dd1348.docx" then error "WPSC_STALE_DOCUMENT"
...
if (count cells of insertedTable) is not 9 then error "WPSC_TABLE_MERGE_READBACK_FAILED"
set nativeRows to {{"created", "table", tableIndex, previousTableCount, number of rows of insertedTable, number of columns of insertedTable, count cells of insertedTable, allow auto fit of insertedTable}}
end tell
end timeout
