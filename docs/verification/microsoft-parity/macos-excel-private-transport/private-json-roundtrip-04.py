...
def main():
    ...
    out=root/'build/excel-command-boundary-20260910/private-json-roundtrip-04';out.mkdir(exist_ok=False)
    ...
    return '''+_object({'deleted':'true'})
      ...
      assert got=={'names':['Data','Results'],'marker':'PRIVATE-JSON-ROUNDTRIP-04','alerts':True},got
