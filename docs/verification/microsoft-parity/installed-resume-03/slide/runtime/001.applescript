...
on sessionOperation()
set nativeHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-dt1gsqj1/bound-003c7331a721449ca1ea3d56a04d766e.pptx") as text
with timeout of 44 seconds
 tell application "Microsoft PowerPoint"
if exists presentation "bound-003c7331a721449ca1ea3d56a04d766e.pptx" then error "Presentation collision"
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-dt1gsqj1/bound-003c7331a721449ca1ea3d56a04d766e.pptx" then error "Owned path mismatch"
return "CREATED"
 end tell
end timeout
