...
on sessionOperation()
set pdfHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-dt1gsqj1/export-f588ab0089834c6e8527e42434c4aa88.pdf") as text
with timeout of 40 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-003c7331a721449ca1ea3d56a04d766e.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-003c7331a721449ca1ea3d56a04d766e.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-dt1gsqj1/bound-003c7331a721449ca1ea3d56a04d766e.pptx" then error "Bound presentation path changed"
