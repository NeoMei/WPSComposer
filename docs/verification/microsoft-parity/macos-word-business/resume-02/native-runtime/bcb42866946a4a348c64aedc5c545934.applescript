...
set semanticStyle to Word style (style heading6) of boundDoc
...
set content of semanticRange to "Direct Heading Six" & return
...
set outline level of paragraph format of semanticRange to outline level6
