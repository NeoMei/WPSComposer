...
set content of semanticRange to "→" & tab & "First literal bullet" & return
...
set semanticRange to create range boundDoc start insertionPoint end insertionPoint
set content of semanticRange to "→" & tab & "Second wrapped literal bullet Second wrapped literal bullet Second wrapped literal bullet Second wrapped literal bullet Second wrapped literal bullet " & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 153)
set style of semanticRange to semanticStyle
reset font object of semanticRange
reset paragraph format of semanticRange
set paragraph format left indent of paragraph format of semanticRange to 24
