...
set semanticCodeStyle to missing value
try
set semanticCodeStyle to Word style "Verbatim Char" of boundDoc
end try
...
set content of semanticRange to "Plain 😀 Bold Code" & return
...
set spanRange to create range boundDoc start (insertionPoint + 0) end (insertionPoint + 9)
...
set spanRange to create range boundDoc start (insertionPoint + 9) end (insertionPoint + 13)
set font size of font object of spanRange to 12
set name of font object of spanRange to "仿宋"
set east asian name of font object of spanRange to "仿宋"
set ascii name of font object of spanRange to "Times New Roman"
...
set underline of font object of spanRange to underline none
set color of font object of spanRange to {0, 0, 0}
set spanRange to create range boundDoc start (insertionPoint + 13) end (insertionPoint + 18)
if semanticCodeStyle is missing value then
set font size of font object of spanRange to 9
set name of font object of spanRange to "Consolas"
set east asian name of font object of spanRange to "Consolas"
set ascii name of font object of spanRange to "Consolas"
set other name of font object of spanRange to "Consolas"
set complex script name of font object of spanRange to "Consolas"
else
set style of spanRange to semanticCodeStyle
end if
set bold of font object of spanRange to false
set italic of font object of spanRange to false
