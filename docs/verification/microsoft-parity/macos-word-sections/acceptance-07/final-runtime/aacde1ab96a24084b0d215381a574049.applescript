...
set content of semanticRange to "Intervening body invalidates pending 中文😀" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 42)
