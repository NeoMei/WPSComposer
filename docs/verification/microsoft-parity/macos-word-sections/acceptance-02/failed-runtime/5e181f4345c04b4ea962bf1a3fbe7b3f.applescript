...
make new variable at boundDoc with properties {name:roleName, variable value:"body😀"}
end if
set ownRole to variable roleName of boundDoc
set variable value of ownRole to "body😀"
if (variable value of ownRole as text) is not "body😀" then error "WPSC_ROLE_READBACK_FAILED"
...
set content of text object of ownHeader to "Section Three"
if (content of text object of ownHeader as text) is not "Section Three" & return then error "WPSC_HEADER_TEXT_FAILED"
...
set content of text object of ownFooter to "Keep footer 3 PAGE NUMPAGES PAGEREF "
if (content of text object of ownFooter as text) is not "Keep footer 3 PAGE NUMPAGES PAGEREF " & return then error "WPSC_HEADER_TEXT_FAILED"
set ownFooter to get footer ownSection index header footer primary
...
set starting number of page number options of ownFooter to 7
...
if starting number of page number options of ownFooter is not 7 then error "WPSC_NUMBERING_READBACK_FAILED"
set footerRange to text object of ownFooter
set pageCount to 0
repeat with fieldIndex from 1 to (count fields of footerRange)
set ownField to field fieldIndex of footerRange
