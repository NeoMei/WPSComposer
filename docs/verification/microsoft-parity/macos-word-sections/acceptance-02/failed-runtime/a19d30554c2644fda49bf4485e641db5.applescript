...
set content of semanticRange to "First duplicate remains portrait 中文😀" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 38)
