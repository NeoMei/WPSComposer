...
set nativeRows to {}
set boundDoc to document "document-ff747cdf5d21477887547d96830b825f.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ihzwr503/document-ff747cdf5d21477887547d96830b825f.docx" then error "WPSC_STALE_DOCUMENT"
...
set page height of page setup of ownSection to 792
set orientation of page setup of ownSection to orient landscape
set top margin of page setup of ownSection to 54
set bottom margin of page setup of ownSection to 54
set left margin of page setup of ownSection to 60
set right margin of page setup of ownSection to 60
set sectionDifference to (page width of page setup of ownSection) - (792)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (page height of page setup of ownSection) - (612)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
if orientation of page setup of ownSection is not orient landscape then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (top margin of page setup of ownSection) - (54)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (bottom margin of page setup of ownSection) - (54)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (left margin of page setup of ownSection) - (60)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (right margin of page setup of ownSection) - (60)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
...
make new variable at boundDoc with properties {name:roleName, variable value:"landscape😀"}
end if
set ownRole to variable roleName of boundDoc
set variable value of ownRole to "landscape😀"
if (variable value of ownRole as text) is not "landscape😀" then error "WPSC_ROLE_READBACK_FAILED"
...
set content of text object of ownHeader to "Section Two"
if (content of text object of ownHeader as text) is not "Section Two" & return then error "WPSC_HEADER_TEXT_FAILED"
...
set content of text object of ownFooter to "Keep footer 2 "
if (content of text object of ownFooter as text) is not "Keep footer 2 " & return then error "WPSC_HEADER_TEXT_FAILED"
set ownFooter to get footer ownSection index header footer primary
...
set number style of page number options of ownFooter to page number style uppercase roman
set restart numbering at section of page number options of ownFooter to true
set starting number of page number options of ownFooter to 5
if number style of page number options of ownFooter is not page number style uppercase roman then error "WPSC_NUMBERING_READBACK_FAILED"
...
if starting number of page number options of ownFooter is not 5 then error "WPSC_NUMBERING_READBACK_FAILED"
set footerRange to text object of ownFooter
set pageCount to 0
repeat with fieldIndex from 1 to (count fields of footerRange)
set ownField to field fieldIndex of footerRange
