...
set content of semanticRange to "重复标题😀" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 7)
...
set nativeRows to {{"heading", pendingHeadingStart, pendingHeadingEnd, 2}}
end tell
end timeout
