...
set sentinelDoc to document "文档122"
if (posix full name of sentinelDoc as text) is not "文档122" then error "SENTINEL_PATH_CHANGED"
if saved of sentinelDoc then error "SENTINEL_SAVED"
if (content of text object of sentinelDoc as text) is not "Section sentinel c9bac9c115f64755896a14c888dd3ce3 中文😀" & return & "" then error "SENTINEL_TEXT_CHANGED"
