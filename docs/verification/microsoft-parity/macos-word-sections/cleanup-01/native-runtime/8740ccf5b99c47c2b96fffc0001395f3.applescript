...
set sentinelDoc to document "文档120"
if (posix full name of sentinelDoc as text) is not "文档120" then error "SENTINEL_PATH_CHANGED"
if saved of sentinelDoc then error "SENTINEL_SAVED"
if (content of text object of sentinelDoc as text) is not "Section sentinel 6e6eba4812374c8a916f0067014d74f0 中文😀" & return & "" then error "SENTINEL_TEXT_CHANGED"
