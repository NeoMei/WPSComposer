...
set content of semanticRange to "Third portrait before pending heading 中文😀" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 43)
