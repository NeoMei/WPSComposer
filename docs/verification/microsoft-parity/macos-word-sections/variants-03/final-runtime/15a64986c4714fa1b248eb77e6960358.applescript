...
set sentinelDoc to document "文档139"
if (content of text object of sentinelDoc as text) is not "Section sentinel e37658ef687541a183295a3ce6e80b27 中文😀" & return then error "SENTINEL_CHANGED"
