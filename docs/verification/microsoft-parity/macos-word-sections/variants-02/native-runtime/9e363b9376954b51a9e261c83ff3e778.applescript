...
set sectionDifference to (page width of page setup of ownSection) - (1190.55)
...
make new variable at boundDoc with properties {name:roleName, variable value:"a3 landscape"}
end if
set ownRole to variable roleName of boundDoc
set variable value of ownRole to "a3 landscape"
if (variable value of ownRole as text) is not "a3 landscape" then error "WPSC_ROLE_READBACK_FAILED"
