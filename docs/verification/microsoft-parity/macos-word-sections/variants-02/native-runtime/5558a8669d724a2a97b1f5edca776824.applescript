...
set nativeRows to {}
set boundDoc to document "document-40f7c479fde947be8a55e4390a16b5c8.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-h3s10buf/document-40f7c479fde947be8a55e4390a16b5c8.docx" then error "WPSC_STALE_DOCUMENT"
...
set orientation of page setup of ownSection to inheritedOrientation
set top margin of page setup of ownSection to 50
set bottom margin of page setup of ownSection to 52
set left margin of page setup of ownSection to 70
set right margin of page setup of ownSection to 72
set expectedDimension to 612
if inheritedOrientation is orient landscape then set expectedDimension to 1008
set sectionDifference to (page width of page setup of ownSection) - (expectedDimension)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set expectedDimension to 1008
if inheritedOrientation is orient landscape then set expectedDimension to 612
set sectionDifference to (page height of page setup of ownSection) - (expectedDimension)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (top margin of page setup of ownSection) - (50)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (bottom margin of page setup of ownSection) - (52)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (left margin of page setup of ownSection) - (70)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
set sectionDifference to (right margin of page setup of ownSection) - (72)
if sectionDifference > 0.1 or sectionDifference < -0.1 then error "WPSC_SECTION_READBACK_FAILED"
...
make new variable at boundDoc with properties {name:roleName, variable value:"inherited landscape"}
end if
set ownRole to variable roleName of boundDoc
set variable value of ownRole to "inherited landscape"
if (variable value of ownRole as text) is not "inherited landscape" then error "WPSC_ROLE_READBACK_FAILED"
