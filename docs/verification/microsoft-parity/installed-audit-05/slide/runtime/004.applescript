...
on sessionOperation()
set pdfHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-yu_q39oe/export-b95c6d97661c42f6ba73f603f5a35128.pdf") as text
with timeout of 34 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-b49601bd580a4a69bed871165bbfbe5e.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-b49601bd580a4a69bed871165bbfbe5e.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-yu_q39oe/bound-b49601bd580a4a69bed871165bbfbe5e.pptx" then error "Bound presentation path changed"
