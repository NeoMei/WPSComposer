...
set ownedBook to workbook "owned-bae74b1d643943eaab22058c0dc35b5f.xlsx"
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-h48fb764/owned-bae74b1d643943eaab22058c0dc35b5f.xlsx" then error "Owned workbook identity mismatch"
set sheetJSONs to {}
...
set resultJSON to "{" & "\"kind\":" & my j("sheet") & ",\"name\":" & my j(name of ownedBook) & ",\"path\":" & my j("/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/build/excel-delete-selection/run-01/after-selected.xlsx") & ",\"saved\":" & my j(saved of ownedBook) & ",\"sheet_count\":" & my j(count of worksheets of ownedBook) & ",\"cells_truncated\":" & my j(truncated) & "}"
