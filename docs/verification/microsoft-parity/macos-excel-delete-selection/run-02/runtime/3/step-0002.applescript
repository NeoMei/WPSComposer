...
set ownedBook to workbook "owned-e8f0f3cef6634463b61e05b8adfc616c.xlsx"
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-4629u7a6/owned-e8f0f3cef6634463b61e05b8adfc616c.xlsx" then error "Owned workbook identity mismatch"
set sheetJSONs to {}
...
set resultJSON to "{" & "\"kind\":" & my j("sheet") & ",\"name\":" & my j(name of ownedBook) & ",\"path\":" & my j("/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/build/excel-delete-selection/run-02/selected.xlsx") & ",\"saved\":" & my j(saved of ownedBook) & ",\"sheet_count\":" & my j(count of worksheets of ownedBook) & ",\"cells_truncated\":" & my j(truncated) & "}"
