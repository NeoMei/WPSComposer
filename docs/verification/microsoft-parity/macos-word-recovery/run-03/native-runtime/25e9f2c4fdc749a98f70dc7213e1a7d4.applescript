...
set identityRange to text object of bookmark "WPSC_F_c9915e64c8164eb69195a2abe8755d" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_c9915e64c8164eb69195a2abe8755d",start of content of identityRange}
if not (exists bookmark "WPSC_R_998397f2f0db4ee2bdea1b75faeb4b" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_998397f2f0db4ee2bdea1b75faeb4b" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_998397f2f0db4ee2bdea1b75faeb4b",start of content of identityRange}
