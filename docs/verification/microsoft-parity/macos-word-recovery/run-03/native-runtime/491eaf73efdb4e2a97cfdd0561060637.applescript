...
set content of literalRange to "Existing "
set insertionPoint to insertionPoint + 9
set literalRange to create range boundDoc start literalStart end insertionPoint
if (content of literalRange as text) is not "Existing " then error "WPSC_REFERENCE_TEXT_UNVERIFIED"
...
make new bookmark at boundDoc with properties {name:"WPSC_R_998397f2f0db4ee2bdea1b75faeb4b", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_998397f2f0db4ee2bdea1b75faeb4b" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",1,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_998397f2f0db4ee2bdea1b75faeb4b"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
