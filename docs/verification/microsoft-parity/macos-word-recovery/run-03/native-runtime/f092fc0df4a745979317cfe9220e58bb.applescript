...
if nativeRows is not {{("checkpoint-state"),1,0,1,1,0,1,("5ec1196c1bed421f255114956dfe40fdb9d4413ea8d0e439cc0f1534901fabbd"),0,0,("missing value"),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("checkpoint-end")}} then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if nativeRows is not {} then error "WPSC_CHECKPOINT_UNPLANNED_FIELD_REMOVAL"
...
set end of nativeRows to {"checkpoint-end"}
if nativeRows is not {{("checkpoint-state"),1,0,1,1,0,1,("5ec1196c1bed421f255114956dfe40fdb9d4413ea8d0e439cc0f1534901fabbd"),0,0,("missing value"),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("checkpoint-end")}} then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
