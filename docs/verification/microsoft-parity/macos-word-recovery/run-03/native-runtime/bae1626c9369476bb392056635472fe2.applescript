...
set content of literalRange to "PARTIAL-TRACKED "
set insertionPoint to insertionPoint + 16
set literalRange to create range boundDoc start literalStart end insertionPoint
if (content of literalRange as text) is not "PARTIAL-TRACKED " then error "WPSC_REFERENCE_TEXT_UNVERIFIED"
...
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
set content of literalRange to "PARTIAL"
set insertionPoint to insertionPoint + 7
set literalRange to create range boundDoc start literalStart end insertionPoint
if (content of literalRange as text) is not "PARTIAL" then error "WPSC_REFERENCE_TEXT_UNVERIFIED"
...
make new bookmark at boundDoc with properties {name:"WPSC_R_0d2155987e99461b8829be93f13d35", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_0d2155987e99461b8829be93f13d35" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",1,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_0d2155987e99461b8829be93f13d35"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
