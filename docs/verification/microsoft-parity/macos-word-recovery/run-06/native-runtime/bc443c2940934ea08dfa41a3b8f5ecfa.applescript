...
if not (exists bookmark "WPSC_F_f2746e33075d40a3a1dfa750f576f2" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set recoveryIdentity to text object of bookmark "WPSC_F_f2746e33075d40a3a1dfa750f576f2" of boundDoc
...
set end of nativeRows to {"bookmark","WPSC_F_f2746e33075d40a3a1dfa750f576f2",start of content of recoveryIdentity,end of content of recoveryIdentity,content of recoveryIdentity as text}
if not (exists bookmark "WPSC_R_4baf0c4e9688423fb04eaa46920ef6" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set recoveryIdentity to text object of bookmark "WPSC_R_4baf0c4e9688423fb04eaa46920ef6" of boundDoc
...
set end of nativeRows to {"bookmark","WPSC_R_4baf0c4e9688423fb04eaa46920ef6",start of content of recoveryIdentity,end of content of recoveryIdentity,content of recoveryIdentity as text}
...
if {("WPSC_F_f2746e33075d40a3a1dfa750f576f2"),("WPSC_R_4baf0c4e9688423fb04eaa46920ef6")} does not contain recoveryBookmarkName then
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,466,467,11,385,467,("e279934649d5d0dc18e3cf3783539f2270755775b5a6e4d82b0d58aaab3cc1f6"),0,232,("Recovery prefix 中文😀" & return & "Chapter" & return & "Contents" & return & "Chapter" & tab & "1" & return & "" & return & "" & (character id 12) & "" & return & "Existing Recovery" & return & ""),("388c99e24d9bf349001dbfef40ab9663ebc9969b9b8b2c99ee52612092d20cf8")},{("table"),1,318,385,1,1},{("field"),("main"),1,("field toc"),(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT "),39,74,75,149},{("field"),("main"),2,("field hyperlink"),(" HYPERLINK \\l \"_Toc239860567\" "),76,107,108,147},{("field"),("main"),3,("field page ref"),(" PAGEREF _Toc239860567 \\h "),117,144,145,146},{("field"),("main"),4,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT "),163,221,222,230},{("field"),("main"),5,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT "),249,307,308,316},{("field"),("main"),6,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\* MERGEFORMAT "),319,373,374,382},{("field"),("main"),7,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\* MERGEFORMAT "),402,456,457,465},{("bookmark"),("WPSC_F_f2746e33075d40a3a1dfa750f576f2"),39,74,(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT ")},{("bookmark"),("WPSC_R_4baf0c4e9688423fb04eaa46920ef6"),163,221,(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT ")},{("bookmark-hash"),("wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa"),0,8,("48f6a8d5688b0cf59fb8109b7903507ed9d2e1580be2ad7ae169df659e1ddeea")},{("bookmark-hash"),("WPSC_R_6f1f02ed1f4c49f095d440e798cd72"),249,307,("2d0403e4dce3fa0cf4cb7f96667dec6c067a4ab0e7e254a02fa26b82ebaf637f")},{("objects"),0,0,1,7,4},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if not ((current application's NSString's stringWithString:(content of field code of recoveryField as text))'s isEqualToString:(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\* MERGEFORMAT ")) or (start of content of field code of recoveryField) is not 402 or (end of content of result range of recoveryField) is not 465 then error "WPSC_CHECKPOINT_FIELD_CHANGED"
...
if not ((current application's NSString's stringWithString:(content of field code of recoveryField as text))'s isEqualToString:(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\* MERGEFORMAT ")) or (start of content of field code of recoveryField) is not 319 or (end of content of result range of recoveryField) is not 382 then error "WPSC_CHECKPOINT_FIELD_CHANGED"
set recoveryBeforeDelete to end of content of text object of boundDoc
delete recoveryField
...
if not ((current application's NSString's stringWithString:(content of field code of recoveryField as text))'s isEqualToString:(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT ")) or (start of content of field code of recoveryField) is not 249 or (end of content of result range of recoveryField) is not 316 then error "WPSC_CHECKPOINT_FIELD_CHANGED"
set recoveryBeforeDelete to end of content of text object of boundDoc
delete recoveryField
...
if exists bookmark "WPSC_R_6f1f02ed1f4c49f095d440e798cd72" of boundDoc then delete bookmark "WPSC_R_6f1f02ed1f4c49f095d440e798cd72" of boundDoc
set nativeRows to {}
repeat with recoveryOrdinal from 1 to count fields of boundDoc
set recoveryObject to field recoveryOrdinal of boundDoc
set end of nativeRows to {"field","main",recoveryOrdinal as integer,field type of recoveryObject as text,content of field code of recoveryObject as text,start of content of field code of recoveryObject,end of content of field code of recoveryObject,start of content of result range of recoveryObject,end of content of result range of recoveryObject}
end repeat
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("field"),("main"),1,("field toc"),(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT "),39,74,75,149},{("field"),("main"),2,("field hyperlink"),(" HYPERLINK \\l \"_Toc239860567\" "),76,107,108,147},{("field"),("main"),3,("field page ref"),(" PAGEREF _Toc239860567 \\h "),117,144,145,146},{("field"),("main"),4,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT "),163,221,222,230}}) then error "WPSC_CHECKPOINT_UNPLANNED_FIELD_REMOVAL"
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,232,233,8,232,233,("e279934649d5d0dc18e3cf3783539f2270755775b5a6e4d82b0d58aaab3cc1f6"),0,232,("Recovery prefix 中文😀" & return & "Chapter" & return & "Contents" & return & "Chapter" & tab & "1" & return & "" & return & "" & (character id 12) & "" & return & "Existing Recovery" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("field"),("main"),1,("field toc"),(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT "),39,74,75,149},{("field"),("main"),2,("field hyperlink"),(" HYPERLINK \\l \"_Toc239860567\" "),76,107,108,147},{("field"),("main"),3,("field page ref"),(" PAGEREF _Toc239860567 \\h "),117,144,145,146},{("field"),("main"),4,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT "),163,221,222,230},{("bookmark"),("WPSC_F_f2746e33075d40a3a1dfa750f576f2"),39,74,(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT ")},{("bookmark"),("WPSC_R_4baf0c4e9688423fb04eaa46920ef6"),163,221,(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT ")},{("bookmark-hash"),("wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa"),0,8,("48f6a8d5688b0cf59fb8109b7903507ed9d2e1580be2ad7ae169df659e1ddeea")},{("objects"),0,0,0,4,3},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
