...
set insertedShape to make new text box at boundDoc with properties {anchor:insertionRange, left position:20, top:80, width:100, height:40}
...
set top of insertedShape to 80
set width of insertedShape to 100
set height of insertedShape to 40
set content of text range of text frame of insertedShape to "New box"
