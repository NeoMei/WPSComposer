...
set identityRange to text object of bookmark "WPSC_F_921c075aacb8476d8b6eeddfcfaff3" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_921c075aacb8476d8b6eeddfcfaff3",start of content of identityRange}
if not (exists bookmark "WPSC_R_d3744f4be2fa47e0a965a64b5590e9" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_d3744f4be2fa47e0a965a64b5590e9" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_d3744f4be2fa47e0a965a64b5590e9",start of content of identityRange}
