...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,466,467,11,385,467,("e279934649d5d0dc18e3cf3783539f2270755775b5a6e4d82b0d58aaab3cc1f6"),0,232,("Recovery prefix 中文😀" & return & "Chapter" & return & "Contents" & return & "Chapter" & tab & "1" & return & "" & return & "" & (character id 12) & "" & return & "Existing Recovery" & return & ""),("388c99e24d9bf349001dbfef40ab9663ebc9969b9b8b2c99ee52612092d20cf8")},{("table"),1,318,385,1,1},{("field"),("main"),1,("field toc"),(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT "),39,74,75,149},{("field"),("main"),2,("field hyperlink"),(" HYPERLINK \\l \"_Toc239854507\" "),76,107,108,147},{("field"),("main"),3,("field page ref"),(" PAGEREF _Toc239854507 \\h "),117,144,145,146},{("field"),("main"),4,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT "),163,221,222,230},{("field"),("main"),5,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT "),249,307,308,316},{("field"),("main"),6,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\* MERGEFORMAT "),319,373,374,382},{("field"),("main"),7,("field ref"),(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\* MERGEFORMAT "),402,456,457,465},{("bookmark"),("WPSC_F_add810dec3c341df9324238e8f5f97"),39,74,(" TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT ")},{("bookmark"),("WPSC_R_ff7bbb69cd9342d3b67179ae6688cd"),163,221,(" REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT ")},{("bookmark-hash"),("wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa"),0,8,("48f6a8d5688b0cf59fb8109b7903507ed9d2e1580be2ad7ae169df659e1ddeea")},{("bookmark-hash"),("WPSC_R_c219d5a1cf7a4b638bc991a84255ec"),249,307,("2d0403e4dce3fa0cf4cb7f96667dec6c067a4ab0e7e254a02fa26b82ebaf637f")},{("objects"),0,0,1,7,4},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if exists bookmark "WPSC_R_c219d5a1cf7a4b638bc991a84255ec" of boundDoc then delete bookmark "WPSC_R_c219d5a1cf7a4b638bc991a84255ec" of boundDoc
set nativeRows to {}
repeat with recoveryOrdinal from 1 to count fields of boundDoc
set recoveryObject to field recoveryOrdinal of boundDoc
set end of nativeRows to {"field","main",recoveryOrdinal as integer,field type of recoveryObject as text,content of field code of recoveryObject as text,start of content of field code of recoveryObject,end of content of field code of recoveryObject,start of content of result range of recoveryObject,end of content of result range of recoveryObject}
