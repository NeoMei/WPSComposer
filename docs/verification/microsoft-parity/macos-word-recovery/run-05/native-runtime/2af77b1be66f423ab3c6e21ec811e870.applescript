...
set identityRange to text object of bookmark "WPSC_F_add810dec3c341df9324238e8f5f97" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_add810dec3c341df9324238e8f5f97",start of content of identityRange}
if not (exists bookmark "WPSC_R_ff7bbb69cd9342d3b67179ae6688cd" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_ff7bbb69cd9342d3b67179ae6688cd" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_ff7bbb69cd9342d3b67179ae6688cd",start of content of identityRange}
