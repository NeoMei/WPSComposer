...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,22,23,3,21,23,("13fba48b55d5e41cbb5073a9a883a3b74f4eceb313ff421ff1ce5bf5d0a4e16f"),0,22,("Shape guard prefix" & return & "/" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("shape"),1,("文本框 2"),("shape type text box"),1988207646,1646549930,21,22,20,20,100,40,0,1,true,("8e12a23757cd42240612f0c3193061b0c7da25ced685922b93005b3670b4c394")},{("inline-shape"),1,616818652,865251517,19,20,20,20,("inline shape picture"),("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")},{("objects"),1,1,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if recoveryBound < 22 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 22 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,22,23,3,21,23,("13fba48b55d5e41cbb5073a9a883a3b74f4eceb313ff421ff1ce5bf5d0a4e16f"),0,22,("Shape guard prefix" & return & "/" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("shape"),1,("文本框 2"),("shape type text box"),1988207646,1646549930,21,22,20,20,100,40,0,1,true,("8e12a23757cd42240612f0c3193061b0c7da25ced685922b93005b3670b4c394")},{("inline-shape"),1,616818652,865251517,19,20,20,20,("inline shape picture"),("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")},{("objects"),1,1,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
