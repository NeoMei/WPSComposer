...
set nativeRows to {}
set boundDoc to document "document-3e51447caee24d628bea4a1d76952e6c.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-qgx_m214/document-3e51447caee24d628bea4a1d76952e6c.docx" then error "WPSC_STALE_DOCUMENT"
set insertionPoint to (end of content of text object of boundDoc) - 1
if insertionPoint is not 0 then error "WPSC_DEGRADATION_ANCHOR_CHANGED"
...
set content of text object of noticeCell to "[GEOMETRY_NOTICE] 中文😀"
...
set nativeRows to {{"private-error",noticeNumber,noticeError}}
end try
set end of nativeRows to {"full-body",content of text object of boundDoc as text,end of content of text object of boundDoc,count tables of boundDoc}
if (count tables of boundDoc) is 1 then
set t to table 1 of boundDoc
set c to get cell from table t row 1 column 1
