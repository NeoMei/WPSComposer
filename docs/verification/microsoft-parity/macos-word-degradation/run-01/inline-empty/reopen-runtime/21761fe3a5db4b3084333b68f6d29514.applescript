...
set nativeRows to {}
set boundDoc to document "document-b872d37d2e404a4e802518898aed229e.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-nb4dvnzx/document-b872d37d2e404a4e802518898aed229e.docx" then error "WPSC_STALE_DOCUMENT"
set recoveryEnd to end of content of text object of boundDoc
set recoveryBound to recoveryEnd - 1
set recoveryTarget to 58
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,83,84,4,83,84,("7994add7e22008ae5e5641a0a1baae0c66581e3f565ba2bca4cbbcc41a84f545"),0,58,("[NOTICE_INLINE_EMPTY: 中文😀]" & return & "FOLLOWING-NORMAL-inline-empty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if recoveryBound < 58 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 58 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,58,59,3,58,59,("7994add7e22008ae5e5641a0a1baae0c66581e3f565ba2bca4cbbcc41a84f545"),0,58,("[NOTICE_INLINE_EMPTY: 中文😀]" & return & "FOLLOWING-NORMAL-inline-empty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
