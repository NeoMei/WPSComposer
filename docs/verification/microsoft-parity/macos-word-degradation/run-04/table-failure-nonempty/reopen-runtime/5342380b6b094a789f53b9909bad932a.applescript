...
set nativeRows to {}
set boundDoc to document "document-df2cddc917834e1d841089e962796dc6.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-9rezxs33/document-df2cddc917834e1d841089e962796dc6.docx" then error "WPSC_STALE_DOCUMENT"
set recoveryEnd to end of content of text object of boundDoc
set recoveryBound to recoveryEnd - 1
set recoveryTarget to 88
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,123,124,4,123,124,("439083f72dd861e1ae3ded0cd49914a649273133c74ee3b1f6909cf600c4ad1c"),0,88,("PREFIX 中文😀[NOTICE_TABLE_FAILURE_NONEMPTY] 中文😀" & return & "FOLLOWING-NORMAL-table-failure-nonempty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if recoveryBound < 88 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 88 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,88,89,3,88,89,("439083f72dd861e1ae3ded0cd49914a649273133c74ee3b1f6909cf600c4ad1c"),0,88,("PREFIX 中文😀[NOTICE_TABLE_FAILURE_NONEMPTY] 中文😀" & return & "FOLLOWING-NORMAL-table-failure-nonempty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
