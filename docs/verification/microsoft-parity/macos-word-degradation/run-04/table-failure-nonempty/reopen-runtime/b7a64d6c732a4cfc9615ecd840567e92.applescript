...
set content of semanticRange to "REOPEN-EDIT-table-failure-nonempty" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 35)
