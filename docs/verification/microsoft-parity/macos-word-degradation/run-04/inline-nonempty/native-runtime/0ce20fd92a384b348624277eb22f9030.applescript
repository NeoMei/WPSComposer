...
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-oqpwnzbb/document-c90946f18bf84e38a6e3d34040d9883c.docx" then error "WPSC_STALE_DOCUMENT"
...
set content of semanticRange to "FOLLOWING-NORMAL-inline-nonempty" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 33)
