...
set nativeRows to {}
set boundDoc to document "document-74e8562955e7485d9c44243c5e31fa63.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-fldhyoy6/document-74e8562955e7485d9c44243c5e31fa63.docx" then error "WPSC_STALE_DOCUMENT"
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,103,104,4,103,104,("b5864b29b8bd2bbbbf8cc79e4896202f3e3dab7f77433861af393f14923117f1"),0,75,("PREFIX 中文😀[NOTICE_INLINE_NONEMPTY: 中文😀]" & return & "FOLLOWING-NORMAL-inline-nonempty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,75,76,3,75,76,("b5864b29b8bd2bbbbf8cc79e4896202f3e3dab7f77433861af393f14923117f1"),0,75,("PREFIX 中文😀[NOTICE_INLINE_NONEMPTY: 中文😀]" & return & "FOLLOWING-NORMAL-inline-nonempty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
