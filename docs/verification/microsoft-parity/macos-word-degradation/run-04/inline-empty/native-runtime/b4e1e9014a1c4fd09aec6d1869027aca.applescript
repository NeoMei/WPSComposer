...
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ihq4bai_/document-570f15d684884a2993f7c4da1277c9d4.docx" then error "WPSC_STALE_DOCUMENT"
...
set content of semanticRange to "FOLLOWING-NORMAL-inline-empty" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 30)
