...
set nativeRows to {}
set boundDoc to document "document-b4f3c5705a1a432e9e975429ae5b1f4b.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wzsxfwb1/document-b4f3c5705a1a432e9e975429ae5b1f4b.docx" then error "WPSC_STALE_DOCUMENT"
set recoveryEnd to end of content of text object of boundDoc
set recoveryBound to recoveryEnd - 1
set recoveryTarget to 75
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,102,103,7,102,103,("eac6d8c605fb1e6343de5abd090a9754bbeee7f9c2f0c4f56504a9b2992f0caa"),0,75,("PREFIX 中文😀" & return & "[NOTICE_BLOCK_NONEMPTY] 中文😀" & return & "" & (character id 7) & "" & return & "" & (character id 7) & "" & return & "FOLLOWING-NORMAL-block-nonempty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("table"),1,12,42,1,1},{("objects"),0,0,1,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
set recoveryDeletedFields to {}
set recoveryDeletedTables to {}
set recoveryLiveTables to {{("table"),1,12,42,1,1}}
set nativeRows to {}
repeat with recoveryOrdinal from 1 to count fields of boundDoc
set recoveryObject to field recoveryOrdinal of boundDoc
set end of nativeRows to {"field","main",recoveryOrdinal as integer,field type of recoveryObject as text,content of field code of recoveryObject as text,start of content of field code of recoveryObject,end of content of field code of recoveryObject,start of content of result range of recoveryObject,end of content of result range of recoveryObject}
...
if recoveryBound < 75 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 75 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,75,76,6,75,76,("eac6d8c605fb1e6343de5abd090a9754bbeee7f9c2f0c4f56504a9b2992f0caa"),0,75,("PREFIX 中文😀" & return & "[NOTICE_BLOCK_NONEMPTY] 中文😀" & return & "" & (character id 7) & "" & return & "" & (character id 7) & "" & return & "FOLLOWING-NORMAL-block-nonempty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("table"),1,12,42,1,1},{("objects"),0,0,1,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
