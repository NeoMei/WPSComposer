...
set nativeRows to {}
set boundDoc to document "document-190b4d136fce46dd87c2773a33b7b03b.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-zmrdls7y/document-190b4d136fce46dd87c2773a33b7b03b.docx" then error "WPSC_STALE_DOCUMENT"
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,24,25,3,24,25,("5ec1196c1bed421f255114956dfe40fdb9d4413ea8d0e439cc0f1534901fabbd"),0,0,("missing value"),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("table"),1,0,24,1,1},{("objects"),0,0,1,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
set recoveryDeletedFields to {}
set recoveryDeletedTables to {}
set recoveryLiveTables to {{("table"),1,0,24,1,1}}
set nativeRows to {}
repeat with recoveryOrdinal from 1 to count fields of boundDoc
set recoveryObject to field recoveryOrdinal of boundDoc
set end of nativeRows to {"field","main",recoveryOrdinal as integer,field type of recoveryObject as text,content of field code of recoveryObject as text,start of content of field code of recoveryObject,end of content of field code of recoveryObject,start of content of result range of recoveryObject,end of content of result range of recoveryObject}
...
set end of recoveryDeletedTables to {("table"),1,0,24,1,1}
set recoveryBound to (end of content of text object of boundDoc) - 1
if recoveryBound < 0 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 0 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,0,1,1,0,1,("5ec1196c1bed421f255114956dfe40fdb9d4413ea8d0e439cc0f1534901fabbd"),0,0,("missing value"),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
