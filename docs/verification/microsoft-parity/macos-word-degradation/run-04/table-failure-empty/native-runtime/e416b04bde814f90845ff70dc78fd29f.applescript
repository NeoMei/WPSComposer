...
set content of semanticRange to "FOLLOWING-NORMAL-table-failure-empty" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 37)
