...
set content of semanticRange to "REOPEN-EDIT-block-nonempty" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 27)
