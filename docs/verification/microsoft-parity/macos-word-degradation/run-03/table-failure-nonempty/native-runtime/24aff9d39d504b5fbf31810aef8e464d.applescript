...
set content of semanticRange to "FOLLOWING-NORMAL-table-failure-nonempty" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 40)
