...
set nativeRows to {}
set boundDoc to document "document-58419fc00ee24a8b82f98cfbee8f5667.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ka_hq6lv/document-58419fc00ee24a8b82f98cfbee8f5667.docx" then error "WPSC_STALE_DOCUMENT"
set recoveryEnd to end of content of text object of boundDoc
set recoveryBound to recoveryEnd - 1
set recoveryTarget to 71
...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,103,104,4,103,104,("24eb03f57fb892a6830f189003b7e353d1633a2963fc4713a34fa7a79fcc0ef8"),0,71,("[NOTICE_TABLE_FAILURE_EMPTY] 中文😀" & return & "FOLLOWING-NORMAL-table-failure-empty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
...
if recoveryBound < 71 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 71 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,71,72,3,71,72,("24eb03f57fb892a6830f189003b7e353d1633a2963fc4713a34fa7a79fcc0ef8"),0,71,("[NOTICE_TABLE_FAILURE_EMPTY] 中文😀" & return & "FOLLOWING-NORMAL-table-failure-empty" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("objects"),0,0,0,0,0},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
