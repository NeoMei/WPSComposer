...
set ownerNonce to "14671744fc5a48c8b639e377c6115891"
tell application "/Applications/Microsoft Excel.app"
if (count of workbooks) is not 1 then error "Foreign workbooks"
set b to workbook "owned-16c8b61f62a04a7c91d7ef30c1608e7e.xlsx"
if full name of b is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-gy717vms/owned-16c8b61f62a04a7c91d7ef30c1608e7e.xlsx" then error "Workbook identity mismatch"
close b saving no
