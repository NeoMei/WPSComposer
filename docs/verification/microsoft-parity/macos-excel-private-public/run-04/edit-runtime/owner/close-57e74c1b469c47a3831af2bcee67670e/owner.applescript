...
set ownerNonce to "57e74c1b469c47a3831af2bcee67670e"
tell application "/Applications/Microsoft Excel.app"
if (count of workbooks) is not 1 then error "Foreign workbooks"
set b to workbook "owned-ca0eb89ecc5245b191d1f049383475ef.xlsx"
if full name of b is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-bhvepely/owned-ca0eb89ecc5245b191d1f049383475ef.xlsx" then error "Workbook identity mismatch"
close b saving no
