...
set layoutShape to make new line shape at end of targetSlide with properties {name:"wpscomposer-b50822204e724bbcbc0ea5d0dbc457ab",begin line X:40,begin line Y:412.0,end line X:490,end line Y:412.0}
set line weight of line format of layoutShape to 4
set fore color of line format of layoutShape to {170, 68, 34}
set layoutShape to make new shape at end of targetSlide with properties {name:"wpscomposer-8929732e0d1a4f1ba0ae7e4dccc89979",left position:560,top:80,width:220,height:120,auto shape type:autoshape rectangle}
...
set layoutShape to make new text box at end of targetSlide with properties {name:"wpscomposer-9e59e01ae8d9438f8c0cb9eb172275f5",left position:560,top:240,width:300,height:65}
