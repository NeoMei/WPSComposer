...
on sessionOperation()
with timeout of 118 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-9a41a3d34d6d48aebb4b1a014d005090.pptx" then set identityCount to identityCount + 1
end repeat
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-o4azkd47/bound-9a41a3d34d6d48aebb4b1a014d005090.pptx" then error "Bound presentation path changed"
...
set content of targetText to "Explicit save current native"
return "PATCHED"
 end tell
end timeout
