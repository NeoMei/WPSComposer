...
on sessionOperation()
set pdfHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-2zos1127/export-f246cbbf8b5c43dda44a7ff9cf301f71.pdf") as text
with timeout of 63 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-dad783fcfb104482bf47915b1779b2db.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-dad783fcfb104482bf47915b1779b2db.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-2zos1127/bound-dad783fcfb104482bf47915b1779b2db.pptx" then error "Bound presentation path changed"
