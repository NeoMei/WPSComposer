...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-fbd51e550fef4efc81a7b281148e08aa.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-fbd51e550fef4efc81a7b281148e08aa.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-hf78xp7q/bound-fbd51e550fef4efc81a7b281148e08aa.pptx" then error "Bound presentation path changed"
