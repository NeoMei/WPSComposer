...
set follow master background of targetSlide to false
set visible of fill format of background of targetSlide to true
set fore color of fill format of background of targetSlide to {238, 244, 250}
return "PATCHED"
 end tell
end timeout
