...
on sessionOperation()
with timeout of 164 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-30136b31172344cb80ec034b5e3cc613.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-30136b31172344cb80ec034b5e3cc613.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-4ub_8cbb/bound-30136b31172344cb80ec034b5e3cc613.pptx" then error "Bound presentation path changed"
set targetSlide to slide 5 of ownedDoc
set currentShape to make new text box at end of targetSlide with properties {name:"wpscomposer-90e77f6b9ff240248d7f2cb80592ace3",left position:40,top:30,width:300,height:55}
set content of text range of text frame of currentShape to "Native textbox"
set font size of font of text range of text frame of currentShape to 24
set bold of font of text range of text frame of currentShape to true
set alignment of paragraph format of text range of text frame of currentShape to paragraph align center
set font color of font of text range of text frame of currentShape to {18, 52, 86}
set visible of fill format of currentShape to false
