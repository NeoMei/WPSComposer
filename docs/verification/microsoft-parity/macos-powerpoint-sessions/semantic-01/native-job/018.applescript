...
set layoutShape to make new line shape at end of targetSlide with properties {name:"wpscomposer-925c69e7b326449e8a95498678e22ad2",begin line X:40,begin line Y:412.0,end line X:490,end line Y:412.0}
set line weight of line format of layoutShape to 4
set fore color of line format of layoutShape to {170, 68, 34}
set layoutShape to make new shape at end of targetSlide with properties {name:"wpscomposer-542e1064109d42bbb59acc2d3f7ef1bc",left position:560,top:80,width:220,height:120,auto shape type:autoshape rectangle}
...
set layoutShape to make new text box at end of targetSlide with properties {name:"wpscomposer-7b13a5cbe9c7465ab0f6ead05ce1b351",left position:560,top:240,width:300,height:65}
