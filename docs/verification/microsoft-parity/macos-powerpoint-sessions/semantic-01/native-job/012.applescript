...
set currentShape to make new shape at end of targetSlide with properties {name:"wpscomposer-cb5e387015834eaab1b325c509d8be2a",left position:40,top:115,width:180,height:80,auto shape type:autoshape rounded rectangle}
set visible of fill format of currentShape to true
set fore color of fill format of currentShape to {34, 102, 153}
set transparency of line format of currentShape to 0
set fore color of line format of currentShape to {255, 170, 0}
set content of text range of text frame of currentShape to "Rounded shape"
