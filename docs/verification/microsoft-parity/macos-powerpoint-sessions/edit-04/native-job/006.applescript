...
repeat with shapeIndex from 1 to (count of shapes of targetSlide)
 if name of shape shapeIndex of targetSlide is "parity-image" then set end of matchingShapes to shapeIndex
end repeat
...
set left position of targetShape to 300
set width of targetShape to 120
return "PATCHED"
 end tell
end timeout
