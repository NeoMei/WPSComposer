...
on sessionOperation()
with timeout of 96 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-64fc30b0b01245cda4be446fc52a6692.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-64fc30b0b01245cda4be446fc52a6692.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-oum7nl89/bound-64fc30b0b01245cda4be446fc52a6692.pptx" then error "Bound presentation path changed"
try
set boundView to view of document window 1 of ownedDoc
set slide of boundView to slide 2 of ownedDoc
cut shape shape 3 of slide 1 of ownedDoc
paste object boundView
return my encodeJSON({"PASS",count of shapes of slide 1 of ownedDoc,count of shapes of slide 2 of ownedDoc})
on error errorText number errorNumber
return my encodeJSON({"FAIL",errorText,errorNumber})
end try
 end tell
end timeout
