...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-752e1b33623e4991bd8f4c670e2f83bc.pptx" then set identityCount to identityCount + 1
end repeat
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-fz2qnsni/bound-752e1b33623e4991bd8f4c670e2f83bc.pptx" then error "Bound presentation path changed"
