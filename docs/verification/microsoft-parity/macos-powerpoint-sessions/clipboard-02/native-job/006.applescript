...
if 4 is (count of slides of ownedDoc) + 1 then
set addedSlide to make new slide at end of ownedDoc with properties {layout:slide layout blank}
else
set addedSlide to make new slide at before slide 4 of ownedDoc with properties {layout:slide layout blank}
end if
return slide index of addedSlide
 end tell
end timeout
