...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-3dd07a50d6f64ef486c57a9ea2acaa55.pptx" then set identityCount to identityCount + 1
end repeat
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-9_k5mn7l/bound-3dd07a50d6f64ef486c57a9ea2acaa55.pptx" then error "Bound presentation path changed"
