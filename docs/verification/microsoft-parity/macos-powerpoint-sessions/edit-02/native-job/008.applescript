...
set addedShape to make new text box at end of targetSlide with properties {left position:60,top:100,width:500,height:80}
set content of text range of text frame of addedShape to "Inserted native session text"
return count of shapes of targetSlide
 end tell
end timeout
