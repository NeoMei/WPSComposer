...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-5e199cd380ee46c78fbdf511d4fac59c.pptx" then set identityCount to identityCount + 1
end repeat
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-alb4vggv/bound-5e199cd380ee46c78fbdf511d4fac59c.pptx" then error "Bound presentation path changed"
...
set content of text range of text frame of sentinelShape to "Logical save sentinel 6b06c5d196d44fa2a75266c6f730644b 中文😀"
