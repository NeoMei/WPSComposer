...
on sessionOperation()
set nativeHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-alb4vggv/bound-5e199cd380ee46c78fbdf511d4fac59c.pptx") as text
with timeout of 179 seconds
 tell application "Microsoft PowerPoint"
if exists presentation "bound-5e199cd380ee46c78fbdf511d4fac59c.pptx" then error "Presentation collision"
...
set ownedDoc to presentation "bound-5e199cd380ee46c78fbdf511d4fac59c.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-alb4vggv/bound-5e199cd380ee46c78fbdf511d4fac59c.pptx" then error "Owned path mismatch"
return "CREATED"
 end tell
end timeout
