...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-c58a7713c32e478881aadf898354fd19.pptx" then set identityCount to identityCount + 1
end repeat
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-bs0u8zeg/bound-c58a7713c32e478881aadf898354fd19.pptx" then error "Bound presentation path changed"
...
set content of targetText to "OPEN LATER EDIT"
return "PATCHED"
 end tell
end timeout
