...
on sessionOperation()
with timeout of 167 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-69c5ddde53a149178c0632063e985232.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-69c5ddde53a149178c0632063e985232.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-rbj2mbtk/bound-69c5ddde53a149178c0632063e985232.pptx" then error "Bound presentation path changed"
set d to presentation "演示文稿74"
if saved of d then error "SENTINEL_SAVED"
if content of text range of text frame of shape 1 of slide 1 of d is not "Logical save sentinel 6b1e9fea29bf4b93b56ec007cdce70a9 中文😀" then error "SENTINEL_CHANGED"
close d saving no
return "CLOSED"
 end tell
end timeout
