...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-10f4f5eb14934d3fba8ea83b86d87b65.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-10f4f5eb14934d3fba8ea83b86d87b65.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-fithd6ki/bound-10f4f5eb14934d3fba8ea83b86d87b65.pptx" then error "Bound presentation path changed"
set d to presentation "演示文稿72"
if saved of d then error "SENTINEL_SAVED"
if content of text range of text frame of shape 1 of slide 1 of d is not "Logical save sentinel 7fa7f8d518084c5da8192841b1c94357 中文😀" then error "SENTINEL_CHANGED"
close d saving no
return "CLOSED"
 end tell
end timeout
