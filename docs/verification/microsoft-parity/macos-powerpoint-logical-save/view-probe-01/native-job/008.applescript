...
set d to presentation "演示文稿68"
if saved of d then error "SENTINEL_SAVED"
if content of text range of text frame of shape 1 of slide 1 of d is not "View sentinel a3cfd48c1ca04913a5436ce3a0a69ff4 中文😀" then error "SENTINEL_CHANGED"
close d saving no
return "CLOSED"
 end tell
end timeout
