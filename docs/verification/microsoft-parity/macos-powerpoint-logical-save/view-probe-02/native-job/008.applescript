...
set d to presentation "演示文稿70"
if saved of d then error "SENTINEL_SAVED"
if content of text range of text frame of shape 1 of slide 1 of d is not "View sentinel c418fdb992904236a95671c9a18ad289 中文😀" then error "SENTINEL_CHANGED"
close d saving no
return "CLOSED"
 end tell
end timeout
