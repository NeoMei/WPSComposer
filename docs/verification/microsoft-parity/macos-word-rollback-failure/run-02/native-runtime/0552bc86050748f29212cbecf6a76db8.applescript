...
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,119,120,4,119,120,("d4fcc7f16249392bbd72bc79723ded8a2dbf2b0bbdc4ed02dd8f0ba3ad68550c"),0,30,("Rollback original prefix 中文😀" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("table"),1,30,119,1,1},{("field"),("main"),1,("field ref"),(" REF WPSC_RollbackFailureTarget \\* MERGEFORMAT "),31,78,79,87},{("bookmark-hash"),("WPSC_RollbackFailureTarget"),0,8,("c591f5574995c7403a2883c4d68c74b4d1e1b12e0a3689d0383ff28887bc0efe")},{("objects"),0,0,1,1,1},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_PREFLIGHT_CHANGED"
set recoveryDeletedFields to {}
set recoveryDeletedTables to {}
set recoveryLiveTables to {{("table"),1,30,119,1,1}}
set recoveryField to field 1 of boundDoc
if not ((current application's NSString's stringWithString:(content of field code of recoveryField as text))'s isEqualToString:(" REF WPSC_RollbackFailureTarget \\* MERGEFORMAT ")) or (start of content of field code of recoveryField) is not 31 or (end of content of result range of recoveryField) is not 87 then error "WPSC_CHECKPOINT_FIELD_CHANGED"
set recoveryBeforeDelete to end of content of text object of boundDoc
delete recoveryField
error "WPSC_INJECTED_ROLLBACK_FAILURE"
set end of recoveryDeletedFields to {("field"),("main"),1,("field ref"),(" REF WPSC_RollbackFailureTarget \\* MERGEFORMAT "),31,78,79,87}
...
if item 3 of recoveryTableFact >= 88 then set item 3 of recoveryTableFact to (item 3 of recoveryTableFact) - recoveryDelta
if item 4 of recoveryTableFact >= 88 then set item 4 of recoveryTableFact to (item 4 of recoveryTableFact) - recoveryDelta
end repeat
set nativeRows to {}
repeat with recoveryOrdinal from 1 to count fields of boundDoc
set recoveryObject to field recoveryOrdinal of boundDoc
...
set end of recoveryDeletedTables to {("table"),1,30,119,1,1}
set recoveryBound to (end of content of text object of boundDoc) - 1
if recoveryBound < 30 then error "WPSC_CHECKPOINT_BOUND_FAILED"
set rollbackRange to create range boundDoc start 30 end recoveryBound
...
set end of nativeRows to {"objects",count shapes of boundDoc,count inline shapes of boundDoc,count tables of boundDoc,count fields of boundDoc,count bookmarks of boundDoc}
set end of nativeRows to {"checkpoint-end"}
if not ((current application's NSArray's arrayWithArray:nativeRows)'s isEqualToArray:{{("checkpoint-state"),1,30,31,2,30,31,("d4fcc7f16249392bbd72bc79723ded8a2dbf2b0bbdc4ed02dd8f0ba3ad68550c"),0,30,("Rollback original prefix 中文😀" & return & ""),("9d1e0e2d9459d06523ad13e28a4093c2316baafe7aec5b25f30eba2e113599c4")},{("bookmark-hash"),("WPSC_RollbackFailureTarget"),0,8,("c591f5574995c7403a2883c4d68c74b4d1e1b12e0a3689d0383ff28887bc0efe")},{("objects"),0,0,0,0,1},{("checkpoint-end")}}) then error "WPSC_CHECKPOINT_POSTCONDITION_FAILED"
