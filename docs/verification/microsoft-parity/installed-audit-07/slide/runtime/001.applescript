...
on sessionOperation()
set nativeHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-6aimjl1s/bound-2be8a69584e74815896983bf8f31a539.pptx") as text
with timeout of 44 seconds
 tell application "Microsoft PowerPoint"
if exists presentation "bound-2be8a69584e74815896983bf8f31a539.pptx" then error "Presentation collision"
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-6aimjl1s/bound-2be8a69584e74815896983bf8f31a539.pptx" then error "Owned path mismatch"
return "CREATED"
 end tell
end timeout
