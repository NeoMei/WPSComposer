...
on sessionOperation()
with timeout of 57 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-189e9bf5f031405c836bd7afa88fbb4e.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-189e9bf5f031405c836bd7afa88fbb4e.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-5rjly57g/bound-189e9bf5f031405c836bd7afa88fbb4e.pptx" then error "Bound presentation path changed"
set targetSlide to slide 1 of ownedDoc
set currentShape to make new text box at end of targetSlide with properties {name:"wpscomposer-73dc44cdeca34b9488e0ddaa62dbda09",left position:30,top:30,width:260,height:40}
set content of text range of text frame of currentShape to "Size probe 720 x 405"
