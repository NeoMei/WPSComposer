...
on sessionOperation()
with timeout of 56 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-73e7b9ce3355482f98d72c692187e915.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-73e7b9ce3355482f98d72c692187e915.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-h9q91li8/bound-73e7b9ce3355482f98d72c692187e915.pptx" then error "Bound presentation path changed"
set targetSlide to slide 1 of ownedDoc
set currentShape to make new text box at end of targetSlide with properties {name:"wpscomposer-37fd66ccdf5144619b5e817ff1be7481",left position:30,top:30,width:260,height:40}
set content of text range of text frame of currentShape to "Size probe 405 x 720"
