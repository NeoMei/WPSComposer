...
set sentinelDoc to document "文档165"
if (content of text object of sentinelDoc as text) is not "Fields sentinel d8767be1ab99494bacf3a40df2ad3a2f 中文😀" & return then error "SENTINEL_CHANGED"
