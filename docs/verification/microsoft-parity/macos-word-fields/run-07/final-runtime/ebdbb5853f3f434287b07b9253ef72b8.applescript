...
set sentinelDoc to document "文档153"
if (content of text object of sentinelDoc as text) is not "Fields sentinel ead541e67658430b86579b5fb50c382d 中文😀" & return then error "SENTINEL_CHANGED"
