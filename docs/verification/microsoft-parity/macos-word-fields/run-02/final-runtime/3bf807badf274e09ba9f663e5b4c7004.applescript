...
set ownStory to missing value
try
set ownStory to get story range boundDoc story type footnote continuation separator story
on error errorMessage number errorNumber
if errorNumber is not -5941 then error errorMessage number errorNumber
end try
set chainIndex to 0
...
set ownStory to missing value
try
set ownStory to get story range boundDoc story type endnote continuation separator story
on error errorMessage number errorNumber
if errorNumber is not -5941 then error errorMessage number errorNumber
end try
set chainIndex to 0
