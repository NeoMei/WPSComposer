...
set sentinelDoc to document "文档143"
if (content of text object of sentinelDoc as text) is not "Fields sentinel eabffe281c324654b83b66aad3b76626 中文😀" & return then error "SENTINEL_CHANGED"
