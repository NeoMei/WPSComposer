...
if not (exists bookmark "WPSC_F_85590ea22659408e93cbc510bfc58a" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_85590ea22659408e93cbc510bfc58a" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_85590ea22659408e93cbc510bfc58a",start of content of identityRange}
if not (exists bookmark "WPSC_F_3d1454d6d4264e9a819eb1311156d7" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_3d1454d6d4264e9a819eb1311156d7" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_3d1454d6d4264e9a819eb1311156d7",start of content of identityRange}
if not (exists bookmark "WPSC_F_b66ef0129b6040d1bb6dca2b402b9c" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_b66ef0129b6040d1bb6dca2b402b9c" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_FIG\" \\h \\z " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_b66ef0129b6040d1bb6dca2b402b9c",start of content of identityRange}
if not (exists bookmark "WPSC_F_235c5c7bb113466496636598e7d56f" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_235c5c7bb113466496636598e7d56f" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_TAB\" \\h \\z " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_235c5c7bb113466496636598e7d56f",start of content of identityRange}
