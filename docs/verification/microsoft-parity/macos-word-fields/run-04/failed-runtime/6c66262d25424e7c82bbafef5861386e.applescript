...
set content of semanticRange to "Tables😀" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 9)
try
set semanticStyle to Word style "Body Text" of boundDoc
on error
set semanticStyle to Word style (style body text) of boundDoc
end try
...
create new field text range indexRange field type field toc field text "\\c \"WPSC_TAB\" \\h \\z" preserve formatting true
...
make new bookmark at boundDoc with properties {name:"WPSC_F_235c5c7bb113466496636598e7d56f", text object:field code of ownField}
