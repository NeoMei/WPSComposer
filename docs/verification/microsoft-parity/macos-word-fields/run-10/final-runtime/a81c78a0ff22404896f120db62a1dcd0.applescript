...
set semanticStyle to Word style (style heading3) of boundDoc
...
set content of semanticRange to "Heading 😀 Duplicate" & return
...
set outline level of paragraph format of semanticRange to outline level3
...
set nativeRows to {{"heading", pendingHeadingStart, pendingHeadingEnd, 3}}
end tell
end timeout
