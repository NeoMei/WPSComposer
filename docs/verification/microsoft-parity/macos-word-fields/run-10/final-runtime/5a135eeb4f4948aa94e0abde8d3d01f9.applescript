...
if not (exists bookmark "WPSC_F_8833d89dba6043a2b7984a5df24ac5" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_8833d89dba6043a2b7984a5df24ac5" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_8833d89dba6043a2b7984a5df24ac5",start of content of identityRange}
if not (exists bookmark "WPSC_F_b718e5b79b204d73b476d040663223" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_b718e5b79b204d73b476d040663223" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_b718e5b79b204d73b476d040663223",start of content of identityRange}
if not (exists bookmark "WPSC_F_cc20e03093674c69b01f2ab00f4234" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_cc20e03093674c69b01f2ab00f4234" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_FIG\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_cc20e03093674c69b01f2ab00f4234",start of content of identityRange}
if not (exists bookmark "WPSC_F_8926dd8234e54e59a0f297988786f5" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_8926dd8234e54e59a0f297988786f5" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_TAB\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_8926dd8234e54e59a0f297988786f5",start of content of identityRange}
