...
set sentinelDoc to document "文档161"
if (content of text object of sentinelDoc as text) is not "Fields sentinel edf6c8ca73214103ba5e0f5122ca2389 中文😀" & return then error "SENTINEL_CHANGED"
