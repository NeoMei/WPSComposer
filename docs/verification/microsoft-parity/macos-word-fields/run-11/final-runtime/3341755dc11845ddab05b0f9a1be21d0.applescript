...
if not (exists bookmark "WPSC_F_8f9f0c4b6ae44708b695f917cdba5d" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_8f9f0c4b6ae44708b695f917cdba5d" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_8f9f0c4b6ae44708b695f917cdba5d",start of content of identityRange}
if not (exists bookmark "WPSC_F_dd4821984101474c94c6b1e564d7d4" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_dd4821984101474c94c6b1e564d7d4" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_dd4821984101474c94c6b1e564d7d4",start of content of identityRange}
if not (exists bookmark "WPSC_F_fa9870d1fe9447e8a912144808e1b6" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_fa9870d1fe9447e8a912144808e1b6" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_FIG\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_fa9870d1fe9447e8a912144808e1b6",start of content of identityRange}
if not (exists bookmark "WPSC_F_2be135bdeb044567b0404d3cc95588" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_2be135bdeb044567b0404d3cc95588" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_TAB\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_2be135bdeb044567b0404d3cc95588",start of content of identityRange}
