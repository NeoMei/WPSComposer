...
set nativeRows to {}
set boundDoc to document "document-2e5a0ebb988c400cb93dd37af31cd29b.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wp05ucwx/document-2e5a0ebb988c400cb93dd37af31cd29b.docx" then error "WPSC_STALE_DOCUMENT"
set nativeRows to {{"stats",compute statistics boundDoc statistic statistic pages}}
if not (exists bookmark "WPSC_F_deeccb8a4d554659a9a56e8ab96f76" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_deeccb8a4d554659a9a56e8ab96f76" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_deeccb8a4d554659a9a56e8ab96f76",start of content of identityRange}
