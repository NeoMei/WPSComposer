...
set content of semanticRange to "Growth Contents" & return
...
make new bookmark at boundDoc with properties {name:"WPSC_F_deeccb8a4d554659a9a56e8ab96f76", text object:field code of ownField}
