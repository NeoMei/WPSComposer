...
set sentinelDoc to document "文档157"
if (content of text object of sentinelDoc as text) is not "Fields sentinel c41e0dfdfc2f4a25bcd20f31b8e52d63 中文😀" & return then error "SENTINEL_CHANGED"
