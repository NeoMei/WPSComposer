...
if not (exists bookmark "WPSC_F_840026530aa449238fb0a85b1af454" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_840026530aa449238fb0a85b1af454" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_840026530aa449238fb0a85b1af454",start of content of identityRange}
if not (exists bookmark "WPSC_F_f3ea85a2eecb46ba8e66862dc03839" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_f3ea85a2eecb46ba8e66862dc03839" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_f3ea85a2eecb46ba8e66862dc03839",start of content of identityRange}
if not (exists bookmark "WPSC_F_43fbe0493b6a4b4ba4777b3423447c" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_43fbe0493b6a4b4ba4777b3423447c" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_FIG\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_43fbe0493b6a4b4ba4777b3423447c",start of content of identityRange}
if not (exists bookmark "WPSC_F_dd66ae81ab9f4df786ac6174fbda35" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_dd66ae81ab9f4df786ac6174fbda35" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_TAB\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_dd66ae81ab9f4df786ac6174fbda35",start of content of identityRange}
