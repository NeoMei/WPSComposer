...
set sentinelDoc to document "文档151"
if (content of text object of sentinelDoc as text) is not "Fields sentinel d2aba439dbdc40ecb1f41281a9bcb15d 中文😀" & return then error "SENTINEL_CHANGED"
