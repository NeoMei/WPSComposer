...
set sentinelDoc to document "文档141"
if (content of text object of sentinelDoc as text) is not "Fields sentinel fa441578bb4e47808d06abf4abf5f4ac 中文😀" & return then error "SENTINEL_CHANGED"
