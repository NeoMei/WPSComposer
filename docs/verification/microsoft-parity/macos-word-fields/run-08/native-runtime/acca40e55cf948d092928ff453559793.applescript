...
if not (exists bookmark "WPSC_F_8fa6fcd94f3d4cb1b542e9d37460df" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_8fa6fcd94f3d4cb1b542e9d37460df" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_8fa6fcd94f3d4cb1b542e9d37460df",start of content of identityRange}
if not (exists bookmark "WPSC_F_48196e8babd04c47afc7646916a508" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_48196e8babd04c47afc7646916a508" of boundDoc
if (content of identityRange as text) is not " TOC \\o \"1-3\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_48196e8babd04c47afc7646916a508",start of content of identityRange}
if not (exists bookmark "WPSC_F_304a5f1ff77e4122a7552836402656" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_304a5f1ff77e4122a7552836402656" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_FIG\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_304a5f1ff77e4122a7552836402656",start of content of identityRange}
if not (exists bookmark "WPSC_F_978ba06ea1d74c10a5694fa77b3c1c" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_F_978ba06ea1d74c10a5694fa77b3c1c" of boundDoc
if (content of identityRange as text) is not " TOC \\c \"WPSC_TAB\" \\h \\z \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_F_978ba06ea1d74c10a5694fa77b3c1c",start of content of identityRange}
