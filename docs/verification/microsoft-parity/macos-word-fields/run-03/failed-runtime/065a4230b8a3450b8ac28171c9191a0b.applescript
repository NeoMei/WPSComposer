...
set content of semanticRange to "Styled Contents" & return
...
set ownStyle to Word style (style toc1) of boundDoc
set font size of font object of ownStyle to 11
set ownStyle to Word style (style toc2) of boundDoc
set font size of font object of ownStyle to 10
set ownStyle to Word style (style toc3) of boundDoc
set font size of font object of ownStyle to 9
set ownStyle to Word style (style toc2) of boundDoc
set space after of paragraph format of ownStyle to 2
set insertionPoint to (end of content of text object of boundDoc) - 1
if insertionPoint > 0 then
set precedingRange to create range boundDoc start (insertionPoint - 1) end insertionPoint
if (content of precedingRange as text) is not return then
...
make new bookmark at boundDoc with properties {name:"WPSC_F_1030e242ea514baba20fcc91713fe2", text object:field code of ownField}
...
set nativeRows to {{"index",codeStart,resultEnd}}
end tell
end timeout
