...
set nativeRows to {}
set boundDoc to document "document-de3ed3a665784f88937a75195eb33f4b.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-_dp57cr5/document-de3ed3a665784f88937a75195eb33f4b.docx" then error "WPSC_STALE_DOCUMENT"
...
set inline1 to make new inline picture at inline1Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-_dp57cr5/probe-image.png", link to file:false, save with document:true}
...
set inline2 to make new inline picture at inline2Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-_dp57cr5/probe-image.png", link to file:false, save with document:true}
...
set floatingPicture to make new picture at boundDoc with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-_dp57cr5/probe-image.png", link to file:false, save with document:true, anchor:floatingRange}
...
set blockPicture to make new inline picture at blockRange with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-_dp57cr5/probe-image.png", link to file:false, save with document:true}
...
set candidateText to content of paragraph paragraphIndex of boundDoc as text
if candidateText contains "Following 中文😀 paragraph" then set followingTextReadback to candidateText
end repeat
