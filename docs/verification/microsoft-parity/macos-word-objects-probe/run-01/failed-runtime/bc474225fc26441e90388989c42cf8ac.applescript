...
set inline1 to make new inline picture at inline1Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sw_iddow/probe-image.png", link to file:false, save with document:true}
...
set inline2 to make new inline picture at inline2Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sw_iddow/probe-image.png", link to file:false, save with document:true}
...
set floatingPicture to make new picture at boundDoc with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sw_iddow/probe-image.png", link to file:false, save with document:true, anchor:floatingRange}
...
set blockPicture to make new inline picture at blockRange with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sw_iddow/probe-image.png", link to file:false, save with document:true}
