...
set nativeRows to {}
set boundDoc to document "document-25ba128289b44892a939d69bb43591af.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ip7dyv4e/document-25ba128289b44892a939d69bb43591af.docx" then error "WPSC_STALE_DOCUMENT"
...
set inline1 to make new inline picture at inline1Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ip7dyv4e/probe-image.png", link to file:false, save with document:true}
...
set inline2 to make new inline picture at inline2Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ip7dyv4e/probe-image.png", link to file:false, save with document:true}
...
set floatingPicture to make new picture at boundDoc with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ip7dyv4e/probe-image.png", link to file:false, save with document:true, anchor:floatingRange}
...
set blockPicture to make new inline picture at blockRange with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-ip7dyv4e/probe-image.png", link to file:false, save with document:true}
