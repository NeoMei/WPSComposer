...
set nativeRows to {}
set boundDoc to document "document-e4294e0c8521464c96431f26669e68d1.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-j88n11tj/document-e4294e0c8521464c96431f26669e68d1.docx" then error "WPSC_STALE_DOCUMENT"
...
set inline1 to make new inline picture at inline1Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-j88n11tj/probe-image.png", link to file:false, save with document:true}
...
set inline2 to make new inline picture at inline2Range with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-j88n11tj/probe-image.png", link to file:false, save with document:true}
...
set floatingPicture to make new picture at boundDoc with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-j88n11tj/probe-image.png", link to file:false, save with document:true, anchor:floatingRange}
...
set alternative text of floatingPicture to "Floating 中文😀 alt"
set insertionPoint to (end of content of text object of boundDoc) - 1
if insertionPoint > 0 then
set precedingRange to create range boundDoc start (insertionPoint - 1) end insertionPoint
if (content of precedingRange as text) is not return then
...
set blockPicture to make new inline picture at blockRange with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-j88n11tj/probe-image.png", link to file:false, save with document:true}
