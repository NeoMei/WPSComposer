...
set sentinelDoc to document "文档217"
if (content of text object of sentinelDoc as text) is not "RULES SENTINEL 中文😀 bfc0ed5e75e14416898bc0413b3dde3d" & return then error "WPSC_SENTINEL_CHANGED"
