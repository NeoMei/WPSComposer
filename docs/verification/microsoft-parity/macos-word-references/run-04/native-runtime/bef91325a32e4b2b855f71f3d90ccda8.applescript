...
set sentinelDoc to document "文档180"
if (content of text object of sentinelDoc as text) is not "References sentinel 中文😀 790349fdc8e047c289d5f75791572d40" & return then error "SENTINEL_CHANGED"
