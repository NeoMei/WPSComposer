...
set content of literalRange to "Local "
set insertionPoint to insertionPoint + 6
set literalRange to create range boundDoc start literalStart end insertionPoint
if (content of literalRange as text) is not "Local " then error "WPSC_REFERENCE_TEXT_UNVERIFIED"
...
set content of ownRange to "PARTIAL-NATIVE-FAILURE"
error "CONTROLLED_REFERENCE_CREATION_FAILURE"
...
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
set content of literalRange to "LOCAL-FALLBACK"
set insertionPoint to insertionPoint + 14
set literalRange to create range boundDoc start literalStart end insertionPoint
if (content of literalRange as text) is not "LOCAL-FALLBACK" then error "WPSC_REFERENCE_TEXT_UNVERIFIED"
set end of nativeRows to {"literal",0,literalStart,insertionPoint,content of literalRange as text}
end try
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_2eb46539133e4e3198a7f06de3f7c7", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_2eb46539133e4e3198a7f06de3f7c7" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",0,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_2eb46539133e4e3198a7f06de3f7c7"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
