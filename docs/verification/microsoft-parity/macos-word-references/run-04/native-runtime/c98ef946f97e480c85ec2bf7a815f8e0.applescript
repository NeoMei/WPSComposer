...
if not (exists bookmark "WPSC_R_26e3e9b9f7fa48d8b4d169a603434d" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_26e3e9b9f7fa48d8b4d169a603434d" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_26e3e9b9f7fa48d8b4d169a603434d",start of content of identityRange}
if not (exists bookmark "WPSC_R_688ef6ebc395452cbfdaed319d9407" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_688ef6ebc395452cbfdaed319d9407" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_688ef6ebc395452cbfdaed319d9407",start of content of identityRange}
if not (exists bookmark "WPSC_R_740620894f404c0cbf0765289b5a35" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_740620894f404c0cbf0765289b5a35" of boundDoc
...
set end of nativeRows to {"identity","WPSC_R_740620894f404c0cbf0765289b5a35",start of content of identityRange}
if not (exists bookmark "WPSC_R_cab422a6b8cb4ed6b140e5cea1b294" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_cab422a6b8cb4ed6b140e5cea1b294" of boundDoc
if (content of identityRange as text) is not " REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_R_cab422a6b8cb4ed6b140e5cea1b294",start of content of identityRange}
