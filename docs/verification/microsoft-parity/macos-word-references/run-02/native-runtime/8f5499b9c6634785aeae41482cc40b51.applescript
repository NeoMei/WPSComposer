...
make new bookmark at boundDoc with properties {name:"WPSC_R_7b576eb1587c4208b0ac0cfbac4f5f", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_7b576eb1587c4208b0ac0cfbac4f5f" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",1,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_7b576eb1587c4208b0ac0cfbac4f5f"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
...
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_8f87a007978940228a7d3036141f51", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_8f87a007978940228a7d3036141f51" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",2,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_8f87a007978940228a7d3036141f51"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
...
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_ab96f748fe9849d49c213b5955aaeb", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_ab96f748fe9849d49c213b5955aaeb" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",3,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_ab96f748fe9849d49c213b5955aaeb"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
