...
set content of semanticRange to "References direct native acceptance" & return
set semanticRange to create range boundDoc start insertionPoint end (insertionPoint + 36)
