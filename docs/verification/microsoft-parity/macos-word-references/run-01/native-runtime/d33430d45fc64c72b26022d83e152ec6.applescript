...
make new bookmark at boundDoc with properties {name:"WPSC_R_cc664075a2dd418f86514d6c47e598", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_cc664075a2dd418f86514d6c47e598" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",1,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_cc664075a2dd418f86514d6c47e598"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
...
set insertionPoint to insertionPoint + 0
set literalRange to create range boundDoc start literalStart end insertionPoint
...
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_a4dc6588e5e94ddf8d946c239a51dd", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_a4dc6588e5e94ddf8d946c239a51dd" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",2,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_a4dc6588e5e94ddf8d946c239a51dd"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
...
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_d1e497f56cbe4e01a243a5fa902056", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_d1e497f56cbe4e01a243a5fa902056" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",3,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_d1e497f56cbe4e01a243a5fa902056"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
