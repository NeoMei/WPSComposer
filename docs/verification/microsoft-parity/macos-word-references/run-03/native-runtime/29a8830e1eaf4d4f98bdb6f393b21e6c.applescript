...
make new bookmark at boundDoc with properties {name:"WPSC_R_87aae89aa5ee4e8184ba8677cf1ed9", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_87aae89aa5ee4e8184ba8677cf1ed9" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",1,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_87aae89aa5ee4e8184ba8677cf1ed9"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
...
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_6c3d9683ebe745d0b42af2d007183b", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_6c3d9683ebe745d0b42af2d007183b" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",2,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_6c3d9683ebe745d0b42af2d007183b"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
...
if not referenceFailed and not referenceDegraded then
make new bookmark at boundDoc with properties {name:"WPSC_R_a8c8e3e57ca243e191aa96aa05c3a7", text object:field code of ownField}
if (content of text object of bookmark "WPSC_R_a8c8e3e57ca243e191aa96aa05c3a7" of boundDoc as text) is not referenceCode then error "WPSC_REFERENCE_IDENTITY_UNVERIFIED"
set end of nativeRows to {"reference",3,previousFields,count fields of boundDoc,referenceStart + 1,referenceResultStart,referenceResultEnd,referenceCode,"WPSC_R_a8c8e3e57ca243e191aa96aa05c3a7"}
end if
if not referenceFailed then
set literalStart to insertionPoint
set literalRange to create range boundDoc start insertionPoint end insertionPoint
