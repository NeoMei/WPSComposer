...
set sentinelDoc to document "文档178"
if (content of text object of sentinelDoc as text) is not "References sentinel 中文😀 5b7f7b68a67a4c61a6bf4dbb1babb077" & return then error "SENTINEL_CHANGED"
