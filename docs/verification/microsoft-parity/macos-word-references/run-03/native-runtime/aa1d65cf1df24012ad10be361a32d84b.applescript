...
if not (exists bookmark "WPSC_R_87aae89aa5ee4e8184ba8677cf1ed9" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_87aae89aa5ee4e8184ba8677cf1ed9" of boundDoc
if (content of identityRange as text) is not " REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_R_87aae89aa5ee4e8184ba8677cf1ed9",start of content of identityRange}
if not (exists bookmark "WPSC_R_6c3d9683ebe745d0b42af2d007183b" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_6c3d9683ebe745d0b42af2d007183b" of boundDoc
if (content of identityRange as text) is not " REF wpsc_tab_bbbbbbbbbbbbbbbbbbbbbbbb \\h \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_R_6c3d9683ebe745d0b42af2d007183b",start of content of identityRange}
if not (exists bookmark "WPSC_R_a8c8e3e57ca243e191aa96aa05c3a7" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_a8c8e3e57ca243e191aa96aa05c3a7" of boundDoc
if (content of identityRange as text) is not " REF wpsc_eq_cccccccccccccccccccccccc \\h \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_R_a8c8e3e57ca243e191aa96aa05c3a7",start of content of identityRange}
if not (exists bookmark "WPSC_R_cd82673843944e8e9d9180d47eae8f" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_R_cd82673843944e8e9d9180d47eae8f" of boundDoc
if (content of identityRange as text) is not " REF wpsc_fig_aaaaaaaaaaaaaaaaaaaaaaaa \\h \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_R_cd82673843944e8e9d9180d47eae8f",start of content of identityRange}
