...
set nativeRows to {}
set boundDoc to document "document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx" then error "WPSC_STALE_DOCUMENT"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx") then error "QUALITY_WINDOW_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx") then error "QUALITY_WINDOW_CHANGED"
set qualitySentinel to document "文档95"
if not ((current application's NSString's stringWithString:(name of qualitySentinel as text))'s isEqualToString:"文档95") then error "QUALITY_SENTINEL_NAME"
...
if not ((current application's NSString's stringWithString:(content of text object of qualitySentinel as text))'s isEqualToString:"SEMANTIC MATRIX SENTINEL 中文😀 a3070dff78a14d8ca4be5a1ec5a15321" & return & "") then error "QUALITY_SENTINEL_TEXT"
...
set diagActiveOwned to ((current application's NSString's stringWithString:(posix full name of document of active window as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx") as boolean
if diagActiveOwned is not true then error "DIAG_ACTIVE_OWNER_CHANGED"
set diagSelection to selection of boundWindow
if not ((current application's NSString's stringWithString:(posix full name of document of diagSelection as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-8_pxr1kz/document-6d26ffcfaef14f34a5ee9a8a29ff1804.docx") then error "DIAG_SELECTION_OWNER_CHANGED"
