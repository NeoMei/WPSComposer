...
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sy5f8ugp/document-0ef9f8942121490e8ea046ab367055e8.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sy5f8ugp/document-0ef9f8942121490e8ea046ab367055e8.docx") then error "QUALITY_WINDOW_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sy5f8ugp/document-0ef9f8942121490e8ea046ab367055e8.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sy5f8ugp/document-0ef9f8942121490e8ea046ab367055e8.docx") then error "QUALITY_WINDOW_CHANGED"
...
set diagActiveOwned to ((current application's NSString's stringWithString:(posix full name of document of active window as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sy5f8ugp/document-0ef9f8942121490e8ea046ab367055e8.docx") as boolean
if diagActiveOwned is not true then error "DIAG_ACTIVE_OWNER_CHANGED"
set diagSelection to selection of boundWindow
if not ((current application's NSString's stringWithString:(posix full name of document of diagSelection as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-sy5f8ugp/document-0ef9f8942121490e8ea046ab367055e8.docx") then error "DIAG_SELECTION_OWNER_CHANGED"
...
set diagMessage to ""
try
set diagTable to make new table at diagRange with properties {text object:diagRange,number of rows:4,number of columns:3}
