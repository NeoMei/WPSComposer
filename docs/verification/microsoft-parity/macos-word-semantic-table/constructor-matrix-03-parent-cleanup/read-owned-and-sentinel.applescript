...
if ((current application's NSString's stringWithString:(posix full name of reconciliationCandidate as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-slllu409/document-84d3fb78ec694c61a59ae081eda976bf.docx") then
...
if not ((current application's NSString's stringWithString:(posix full name of reconciliationDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-slllu409/document-84d3fb78ec694c61a59ae081eda976bf.docx") then error "DIAG_OWNED_PATH_CHANGED"
