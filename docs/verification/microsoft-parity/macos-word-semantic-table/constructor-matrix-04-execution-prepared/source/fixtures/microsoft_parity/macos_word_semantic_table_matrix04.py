"""Matrix04: one explicitly authorized range-representation conversion on a fresh copy.
...
from fixtures.microsoft_parity import macos_word_semantic_table_explicit_range_probe as conversion

CASES=(("A-explicit-range-conversion",4,3,19,True,"conversion"),)
SOURCES=[*sorted((ROOT/'skills/WPSComposer').rglob('*.py')),*sorted((ROOT/'fixtures/microsoft_parity').glob('*.py')),
         ROOT/'tests/msoffice/test_semantic_table_explicit_range_preparation.py',ROOT/'tests/msoffice/test_semantic_table_conversion_preparation.py',ROOT/'tests/msoffice/test_semantic_table_matrix02_preparation.py']
