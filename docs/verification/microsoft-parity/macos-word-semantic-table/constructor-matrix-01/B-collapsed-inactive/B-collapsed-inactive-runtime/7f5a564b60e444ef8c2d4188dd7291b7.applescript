...
set nativeRows to {}
set boundDoc to document "document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-c0i35o3m/document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx" then error "WPSC_STALE_DOCUMENT"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-c0i35o3m/document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-c0i35o3m/document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx") then error "QUALITY_WINDOW_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-c0i35o3m/document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-c0i35o3m/document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx") then error "QUALITY_WINDOW_CHANGED"
...
set selection end of selection of boundWindow to 12
activate object (active window of qualitySentinel)
set diagActiveOwned to ((current application's NSString's stringWithString:(posix full name of document of active window as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-c0i35o3m/document-fee0fe2ff95549c2b06e6f90aabbc7fd.docx") as boolean
...
if start of content of diagRange is not 12 or end of content of diagRange is not 12 then error "DIAG_RANGE_CHANGED"
