...
set nativeRows to {}
set boundDoc to document "document-f1308054476f48e8bcbcaa05e785629b.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wcoduj71/document-f1308054476f48e8bcbcaa05e785629b.docx" then error "WPSC_STALE_DOCUMENT"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wcoduj71/document-f1308054476f48e8bcbcaa05e785629b.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wcoduj71/document-f1308054476f48e8bcbcaa05e785629b.docx") then error "QUALITY_WINDOW_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wcoduj71/document-f1308054476f48e8bcbcaa05e785629b.docx") then error "QUALITY_BOUND_PATH_CHANGED"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wcoduj71/document-f1308054476f48e8bcbcaa05e785629b.docx") then error "QUALITY_WINDOW_CHANGED"
...
set diagActiveOwned to ((current application's NSString's stringWithString:(posix full name of document of active window as text))'s isEqualToString:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-wcoduj71/document-f1308054476f48e8bcbcaa05e785629b.docx") as boolean
