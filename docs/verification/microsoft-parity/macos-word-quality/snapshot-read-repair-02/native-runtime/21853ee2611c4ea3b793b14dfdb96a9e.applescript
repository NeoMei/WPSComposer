...
try
set probePhase to "first-page-header-get-story:0: set qr to get story range boundDoc story type first page header story"
log probePhase
set qr to get story range boundDoc story type first page header story
set probePhase to "first-page-header-get-story:1: set probeRows to {{\"story-reference-resolved\"}}"
log probePhase
set probeRows to {{"story-reference-resolved"}}
