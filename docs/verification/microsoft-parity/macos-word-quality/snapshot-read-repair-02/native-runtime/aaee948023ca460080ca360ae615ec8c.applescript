...
try
set probePhase to "primary-footer-get-story:0: set qr to get story range boundDoc story type primary footer story"
log probePhase
set qr to get story range boundDoc story type primary footer story
set probePhase to "primary-footer-get-story:1: set probeRows to {{\"story-reference-resolved\"}}"
log probePhase
