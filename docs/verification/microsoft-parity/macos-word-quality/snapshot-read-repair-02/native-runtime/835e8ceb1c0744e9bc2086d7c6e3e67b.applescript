...
try
set probePhase to "primary-header-link-to-previous:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "primary-header-link-to-previous:1: set qpart to get header qsection index header footer primary"
log probePhase
set qpart to get header qsection index header footer primary
set probePhase to "primary-header-link-to-previous:2: set probeRows to {{\"metadata\",link to previous of qpart}}"
log probePhase
