...
try
set probePhase to "even-pages-header-get-story:0: set qr to get story range boundDoc story type even pages header story"
log probePhase
set qr to get story range boundDoc story type even pages header story
set probePhase to "even-pages-header-get-story:1: set probeRows to {{\"story-reference-resolved\"}}"
log probePhase
