...
try
set probePhase to "first-page-header-count-shapes:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "first-page-header-count-shapes:1: set qpart to get header qsection index header footer first page"
log probePhase
set qpart to get header qsection index header footer first page
set probePhase to "first-page-header-count-shapes:2: set probeRows to {{\"shapes\",(count shapes of qpart)}}"
log probePhase
