...
try
set probePhase to "story-types:0: set probeTypes to get story type of every story range of boundDoc"
log probePhase
set probeTypes to get story type of every story range of boundDoc
set probePhase to "story-types:1: set probeRows to {{\"story-types\",probeTypes}}"
log probePhase
set probeRows to {{"story-types",probeTypes}}
