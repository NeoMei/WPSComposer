...
try
set probePhase to "even-pages-header-is-header:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "even-pages-header-is-header:1: set qpart to get header qsection index header footer even pages"
log probePhase
set qpart to get header qsection index header footer even pages
set probePhase to "even-pages-header-is-header:2: set probeRows to {{\"metadata\",is header of qpart}}"
log probePhase
