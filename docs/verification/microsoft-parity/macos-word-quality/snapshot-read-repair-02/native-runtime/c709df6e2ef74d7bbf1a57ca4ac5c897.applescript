...
try
set probePhase to "even-pages-footer-is-header:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "even-pages-footer-is-header:1: set qpart to get footer qsection index header footer even pages"
log probePhase
set qpart to get footer qsection index header footer even pages
set probePhase to "even-pages-footer-is-header:2: set probeRows to {{\"metadata\",is header of qpart}}"
log probePhase
set probeRows to {{"metadata",is header of qpart}}
