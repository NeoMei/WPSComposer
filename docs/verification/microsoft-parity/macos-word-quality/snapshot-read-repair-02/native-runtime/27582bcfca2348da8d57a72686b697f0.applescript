...
try
set probePhase to "primary-header-get-object:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "primary-header-get-object:1: set qpart to get header qsection index header footer primary"
log probePhase
set qpart to get header qsection index header footer primary
set probePhase to "primary-header-get-object:2: set probeRows to {{\"part-reference-resolved\"}}"
log probePhase
