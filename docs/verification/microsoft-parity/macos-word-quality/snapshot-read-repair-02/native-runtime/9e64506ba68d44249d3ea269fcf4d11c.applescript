...
try
set probePhase to "even-pages-header-index:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "even-pages-header-index:1: set qpart to get header qsection index header footer even pages"
log probePhase
set qpart to get header qsection index header footer even pages
set probePhase to "even-pages-header-index:2: set probeRows to {{\"metadata\",header footer index of qpart as text}}"
log probePhase
