...
try
set probePhase to "even-pages-footer-count-shapes:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "even-pages-footer-count-shapes:1: set qpart to get footer qsection index header footer even pages"
log probePhase
set qpart to get footer qsection index header footer even pages
set probePhase to "even-pages-footer-count-shapes:2: set probeRows to {{\"shapes\",(count shapes of qpart)}}"
log probePhase
set probeRows to {{"shapes",(count shapes of qpart)}}
