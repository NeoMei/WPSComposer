...
try
set probePhase to "even-pages-footer-link-to-previous:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "even-pages-footer-link-to-previous:1: set qpart to get footer qsection index header footer even pages"
log probePhase
set qpart to get footer qsection index header footer even pages
set probePhase to "even-pages-footer-link-to-previous:2: set probeRows to {{\"metadata\",link to previous of qpart}}"
log probePhase
