...
try
set probePhase to "first-page-footer-get-story:0: set qr to get story range boundDoc story type first page footer story"
log probePhase
set qr to get story range boundDoc story type first page footer story
set probePhase to "first-page-footer-get-story:1: set probeRows to {{\"story-reference-resolved\"}}"
log probePhase
