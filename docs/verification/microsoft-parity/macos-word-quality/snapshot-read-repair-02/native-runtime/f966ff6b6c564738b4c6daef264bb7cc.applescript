...
try
set probePhase to "story-count:0: set probeRows to {{\"story-count\",(count story ranges of boundDoc)}}"
log probePhase
set probeRows to {{"story-count",(count story ranges of boundDoc)}}
