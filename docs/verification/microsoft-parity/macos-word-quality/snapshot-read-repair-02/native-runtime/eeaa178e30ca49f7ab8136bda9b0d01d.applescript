...
try
set probePhase to "first-page-header-get-object:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "first-page-header-get-object:1: set qpart to get header qsection index header footer first page"
log probePhase
set qpart to get header qsection index header footer first page
set probePhase to "first-page-header-get-object:2: set probeRows to {{\"part-reference-resolved\"}}"
log probePhase
