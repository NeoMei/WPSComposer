...
try
set probePhase to "first-page-header-index:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "first-page-header-index:1: set qpart to get header qsection index header footer first page"
log probePhase
set qpart to get header qsection index header footer first page
set probePhase to "first-page-header-index:2: set probeRows to {{\"metadata\",header footer index of qpart as text}}"
log probePhase
