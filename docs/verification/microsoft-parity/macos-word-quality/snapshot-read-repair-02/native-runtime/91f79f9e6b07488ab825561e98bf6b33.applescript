...
try
set probePhase to "primary-header-get-story:0: set qr to get story range boundDoc story type primary header story"
log probePhase
set qr to get story range boundDoc story type primary header story
set probePhase to "primary-header-get-story:1: set probeRows to {{\"story-reference-resolved\"}}"
log probePhase
