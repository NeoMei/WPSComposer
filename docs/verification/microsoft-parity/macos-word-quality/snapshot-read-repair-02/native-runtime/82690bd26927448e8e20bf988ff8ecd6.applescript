...
try
set probePhase to "first-page-header-is-header:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "first-page-header-is-header:1: set qpart to get header qsection index header footer first page"
log probePhase
set qpart to get header qsection index header footer first page
set probePhase to "first-page-header-is-header:2: set probeRows to {{\"metadata\",is header of qpart}}"
log probePhase
