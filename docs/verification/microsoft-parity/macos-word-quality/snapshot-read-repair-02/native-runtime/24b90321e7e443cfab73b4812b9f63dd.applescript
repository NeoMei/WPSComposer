...
try
set probePhase to "even-pages-footer-get-story:0: set qr to get story range boundDoc story type even pages footer story"
log probePhase
set qr to get story range boundDoc story type even pages footer story
set probePhase to "even-pages-footer-get-story:1: set probeRows to {{\"story-reference-resolved\"}}"
log probePhase
