...
try
set probePhase to "primary-footer-index:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "primary-footer-index:1: set qpart to get footer qsection index header footer primary"
log probePhase
set qpart to get footer qsection index header footer primary
set probePhase to "primary-footer-index:2: set probeRows to {{\"metadata\",header footer index of qpart as text}}"
log probePhase
