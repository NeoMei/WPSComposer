...
try
set probePhase to "section-object:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "section-object:1: set probeRows to {{\"section-reference-resolved\"}}"
log probePhase
set probeRows to {{"section-reference-resolved"}}
