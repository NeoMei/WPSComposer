...
try
set probePhase to "primary-header-count-shapes:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "primary-header-count-shapes:1: set qpart to get header qsection index header footer primary"
log probePhase
set qpart to get header qsection index header footer primary
set probePhase to "primary-header-count-shapes:2: set probeRows to {{\"shapes\",(count shapes of qpart)}}"
log probePhase
