...
try
set probePhase to "section-setup-values:0: set qi to 1"
log probePhase
set qi to 1
set probePhase to "section-setup-values:1: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "section-setup-values:2: set qsetup to page setup of qsection"
log probePhase
set qsetup to page setup of qsection
set probePhase to "section-setup-values:3: set end of qualityLayout to {\"section\",qi as integer,orientation of qsetup as text,page width of qsetup,page height of qsetup,top margin of "
log probePhase
...
set probePhase to "section-setup-values:4: set probeRows to qualityLayout"
log probePhase
