...
try
set probePhase to "section-setup-object:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "section-setup-object:1: set qsetup to page setup of qsection"
log probePhase
set qsetup to page setup of qsection
set probePhase to "section-setup-object:2: set probeRows to {{\"setup-reference-resolved\"}}"
log probePhase
set probeRows to {{"setup-reference-resolved"}}
