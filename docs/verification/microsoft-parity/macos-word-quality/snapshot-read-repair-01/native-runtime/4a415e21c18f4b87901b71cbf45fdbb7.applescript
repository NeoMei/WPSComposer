...
try
set probePhase to "primary-header-text-object:0: set qsection to section 1 of boundDoc"
log probePhase
set qsection to section 1 of boundDoc
set probePhase to "primary-header-text-object:1: set qpart to get header qsection index header footer primary"
log probePhase
set qpart to get header qsection index header footer primary
set probePhase to "primary-header-text-object:2: set qr to text object of qpart"
log probePhase
set qr to text object of qpart
set probePhase to "primary-header-text-object:3: set probeRows to {{\"text-reference-resolved\"}}"
log probePhase
set probeRows to {{"text-reference-resolved"}}
