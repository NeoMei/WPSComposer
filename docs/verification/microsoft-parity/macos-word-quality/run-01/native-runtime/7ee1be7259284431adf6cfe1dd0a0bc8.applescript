...
set qualitySentinel to document "文档87"
if not ((current application's NSString's stringWithString:(name of qualitySentinel as text))'s isEqualToString:"文档87") then error "QUALITY_SENTINEL_NAME"
...
if not ((current application's NSString's stringWithString:(content of text object of qualitySentinel as text))'s isEqualToString:"QUALITY STAGE ONE SENTINEL 中文😀 aa23fb9a3db64677a66dd37485083725" & return & "") then error "QUALITY_SENTINEL_TEXT"
