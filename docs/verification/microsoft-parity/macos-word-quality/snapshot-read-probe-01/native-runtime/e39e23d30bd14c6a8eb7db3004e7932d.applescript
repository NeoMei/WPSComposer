...
try
set probePhase to "0: set probeRows to {}"
set probeRows to {}
set probePhase to "1: set qsection to section 1 of boundDoc"
set qsection to section 1 of boundDoc
set probePhase to "2: set qheader to get header qsection index header footer primary"
set qheader to get header qsection index header footer primary
set probePhase to "3: set qfooter to get footer qsection index header footer primary"
set qfooter to get footer qsection index header footer primary
repeat with qpart in {qheader,qfooter}
set probePhase to "5: set probeCount to (count shapes of qpart) as integer"
set probeCount to (count shapes of qpart) as integer
set probePhase to "6: set probeReject to (probeCount is not 0)"
set probeReject to (probeCount is not 0)
set probePhase to "7: set end of probeRows to {\"part\",is header of qpart,probeCount,probeReject}"
