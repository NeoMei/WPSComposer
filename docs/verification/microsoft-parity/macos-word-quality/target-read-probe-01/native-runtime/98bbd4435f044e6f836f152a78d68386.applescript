...
set probePhase to "range"
set probeRange to text object of qt
set probePhase to "start"
set probeStart to (start of content of probeRange) as integer
set probePhase to "end"
set probeEnd to (end of content of probeRange) as integer
set probePhase to "left-comparison"
set probeLeft to (probeStart <= probeUpper)
set probePhase to "right-comparison"
set probeRight to (probeEnd >= probeLower)
