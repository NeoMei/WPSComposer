...
set nativeRows to {}
set boundDoc to document "document-cb81bb637ef946c192e2a95469543a9b.docx"
set boundWindow to active window of boundDoc
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-i1xklyz6/document-cb81bb637ef946c192e2a95469543a9b.docx" then error "WPSC_STALE_DOCUMENT"
set qualitySelection to selection of boundWindow
if not ((current application's NSString's stringWithString:(posix full name of boundDoc as text))'s isEqualToString:("/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-i1xklyz6/document-cb81bb637ef946c192e2a95469543a9b.docx")) then error "WPSC_STALE_DOCUMENT"
if not ((current application's NSString's stringWithString:(posix full name of document of boundWindow as text))'s isEqualToString:("/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-i1xklyz6/document-cb81bb637ef946c192e2a95469543a9b.docx")) then error "WPSC_STALE_DOCUMENT"
if not ((current application's NSString's stringWithString:(posix full name of document of qualitySelection as text))'s isEqualToString:("/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-i1xklyz6/document-cb81bb637ef946c192e2a95469543a9b.docx")) then error "WPSC_STALE_DOCUMENT"
...
set probePhase to "story-availability-and-chain:12: set end of qualityLayout to {\"page-story-available\",\"primary header\",probeStoryAvailable}"
log probePhase
set end of qualityLayout to {"page-story-available","primary header",probeStoryAvailable}
...
set probePhase to "story-availability-and-chain:17: set end of qualityLayout to {\"page-story\",\"primary header\",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probe"
log probePhase
set end of qualityLayout to {"page-story","primary header",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probeStoryRange,end of content of probeStoryRange,content of probeStoryRange as text}
...
set probePhase to "story-availability-and-chain:20: set end of qualityLayout to {\"page-field\",\"primary header\",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content of f"
log probePhase
set end of qualityLayout to {"page-field","primary header",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content of field code of qfield as text,content of result range of qfield as text,start of content of field code of qfield,end of content of field code of qfield,start of content of result range of qfield,end of content of result range of qfield,locked of qfield}
end repeat
...
set probePhase to "story-availability-and-chain:46: set end of qualityLayout to {\"page-story-available\",\"primary footer\",probeStoryAvailable}"
log probePhase
set end of qualityLayout to {"page-story-available","primary footer",probeStoryAvailable}
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:51: set end of qualityLayout to {\"page-story\",\"primary footer\",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probe"
log probePhase
set end of qualityLayout to {"page-story","primary footer",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probeStoryRange,end of content of probeStoryRange,content of probeStoryRange as text}
...
log probePhase
set qfield to field probePageFieldOrdinal of probeStoryRange
set probePhase to "story-availability-and-chain:54: set end of qualityLayout to {\"page-field\",\"primary footer\",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content of f"
log probePhase
set end of qualityLayout to {"page-field","primary footer",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content of field code of qfield as text,content of result range of qfield as text,start of content of field code of qfield,end of content of field code of qfield,start of content of result range of qfield,end of content of result range of qfield,locked of qfield}
end repeat
...
set probePhase to "story-availability-and-chain:80: set end of qualityLayout to {\"page-story-available\",\"first page header\",probeStoryAvailable}"
log probePhase
set end of qualityLayout to {"page-story-available","first page header",probeStoryAvailable}
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:85: set end of qualityLayout to {\"page-story\",\"first page header\",probeStoryOrdinal,story type of probeStoryRange as text,start of content of pr"
log probePhase
set end of qualityLayout to {"page-story","first page header",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probeStoryRange,end of content of probeStoryRange,content of probeStoryRange as text}
...
log probePhase
set qfield to field probePageFieldOrdinal of probeStoryRange
set probePhase to "story-availability-and-chain:88: set end of qualityLayout to {\"page-field\",\"first page header\",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content o"
log probePhase
set end of qualityLayout to {"page-field","first page header",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content of field code of qfield as text,content of result range of qfield as text,start of content of field code of qfield,end of content of field code of qfield,start of content of result range of qfield,end of content of result range of qfield,locked of qfield}
end repeat
...
set probePhase to "story-availability-and-chain:114: set end of qualityLayout to {\"page-story-available\",\"first page footer\",probeStoryAvailable}"
log probePhase
set end of qualityLayout to {"page-story-available","first page footer",probeStoryAvailable}
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:119: set end of qualityLayout to {\"page-story\",\"first page footer\",probeStoryOrdinal,story type of probeStoryRange as text,start of content of pr"
log probePhase
set end of qualityLayout to {"page-story","first page footer",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probeStoryRange,end of content of probeStoryRange,content of probeStoryRange as text}
...
log probePhase
set qfield to field probePageFieldOrdinal of probeStoryRange
set probePhase to "story-availability-and-chain:122: set end of qualityLayout to {\"page-field\",\"first page footer\",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content o"
log probePhase
...
set probePhase to "story-availability-and-chain:148: set end of qualityLayout to {\"page-story-available\",\"even pages header\",probeStoryAvailable}"
log probePhase
set end of qualityLayout to {"page-story-available","even pages header",probeStoryAvailable}
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:153: set end of qualityLayout to {\"page-story\",\"even pages header\",probeStoryOrdinal,story type of probeStoryRange as text,start of content of pr"
log probePhase
set end of qualityLayout to {"page-story","even pages header",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probeStoryRange,end of content of probeStoryRange,content of probeStoryRange as text}
...
log probePhase
set qfield to field probePageFieldOrdinal of probeStoryRange
set probePhase to "story-availability-and-chain:156: set end of qualityLayout to {\"page-field\",\"even pages header\",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content o"
log probePhase
set end of qualityLayout to {"page-field","even pages header",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content of field code of qfield as text,content of result range of qfield as text,start of content of field code of qfield,end of content of field code of qfield,start of content of result range of qfield,end of content of result range of qfield,locked of qfield}
end repeat
...
set probePhase to "story-availability-and-chain:182: set end of qualityLayout to {\"page-story-available\",\"even pages footer\",probeStoryAvailable}"
log probePhase
set end of qualityLayout to {"page-story-available","even pages footer",probeStoryAvailable}
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:187: set end of qualityLayout to {\"page-story\",\"even pages footer\",probeStoryOrdinal,story type of probeStoryRange as text,start of content of pr"
log probePhase
set end of qualityLayout to {"page-story","even pages footer",probeStoryOrdinal,story type of probeStoryRange as text,start of content of probeStoryRange,end of content of probeStoryRange,content of probeStoryRange as text}
...
log probePhase
set qfield to field probePageFieldOrdinal of probeStoryRange
set probePhase to "story-availability-and-chain:190: set end of qualityLayout to {\"page-field\",\"even pages footer\",probeStoryOrdinal,probePageFieldOrdinal,field type of qfield as text,content o"
log probePhase
