...
try
set probePhase to "full-format-records-0:0: repeat with probePosition from 0 to 219"
log probePhase
repeat with probePosition from 0 to 219
set probePhase to "full-format-records-0:1: set probeRange to create range boundDoc start probePosition end (probePosition+1)"
log probePhase
set probeRange to create range boundDoc start probePosition end (probePosition+1)
set probePhase to "full-format-records-0:2: set probeFontRecord to (get properties of font object of probeRange) as record"
log probePhase
set probeFontRecord to (get properties of font object of probeRange) as record
set probePhase to "full-format-records-0:3: set probeShadingRecord to (get properties of shading of probeRange) as record"
log probePhase
set probeShadingRecord to (get properties of shading of probeRange) as record
set probePhase to "full-format-records-0:4: set end of probeRows to {probePosition as integer,name of probeFontRecord as text,font size of probeFontRecord,bold of probeFontRecord,itali"
log probePhase
