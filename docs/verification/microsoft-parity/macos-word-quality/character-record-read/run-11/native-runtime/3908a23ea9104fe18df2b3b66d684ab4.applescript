...
try
set probePhase to "production-first-format-0:0: set qa to 0"
log probePhase
set qa to 0
set probePhase to "production-first-format-0:1: set qz to 220"
log probePhase
set qz to 220
set probePhase to "production-first-format-0:2: set qualityFormats to {}"
log probePhase
set qualityFormats to {}
set probePhase to "production-first-format-0:3: repeat with qc from qa to qz - 1"
log probePhase
repeat with qc from qa to qz - 1
set probePhase to "production-first-format-0:4: set qcr to create range boundDoc start qc end (qc + 1)"
log probePhase
set qcr to create range boundDoc start qc end (qc + 1)
set probePhase to "production-first-format-0:5: set qcf to (get properties of font object of qcr) as record"
log probePhase
set qcf to (get properties of font object of qcr) as record
set probePhase to "production-first-format-0:6: set qcs to (get properties of shading of qcr) as record"
log probePhase
set qcs to (get properties of shading of qcr) as record
set probePhase to "production-first-format-0:7: set end of qualityFormats to {name of qcf as text,font size of qcf,bold of qcf,italic of qcf,underline of qcf as text,color of qcf,backgroun"
log probePhase
...
set probePhase to "production-first-format-0:9: set probeRows to qualityFormats"
log probePhase
