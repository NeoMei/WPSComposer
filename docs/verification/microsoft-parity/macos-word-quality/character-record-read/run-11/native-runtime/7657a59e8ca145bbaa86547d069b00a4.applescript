...
try
set probePhase to "record-vs-legacy-200-210:0: set probeFirst to 200"
log probePhase
set probeFirst to 200
set probePhase to "record-vs-legacy-200-210:1: set probeLast to 209"
log probePhase
set probeLast to 209
set probePhase to "record-vs-legacy-200-210:2: repeat with probePosition from probeFirst to probeLast"
log probePhase
repeat with probePosition from probeFirst to probeLast
set probePhase to "record-vs-legacy-200-210:3: set probeRange to create range boundDoc start probePosition end (probePosition+1)"
log probePhase
set probeRange to create range boundDoc start probePosition end (probePosition+1)
set probePhase to "record-vs-legacy-200-210:4: set probeFontReference to font object of probeRange"
log probePhase
set probeFontReference to font object of probeRange
set probePhase to "record-vs-legacy-200-210:5: set probeLegacyRow to {name of probeFontReference as text,font size of probeFontReference,bold of probeFontReference,italic of probeFontRefe"
log probePhase
...
set probePhase to "record-vs-legacy-200-210:6: set probeFontRecord to (get properties of font object of probeRange) as record"
log probePhase
set probeFontRecord to (get properties of font object of probeRange) as record
set probePhase to "record-vs-legacy-200-210:7: set probeShadingRecord to (get properties of shading of probeRange) as record"
log probePhase
set probeShadingRecord to (get properties of shading of probeRange) as record
set probePhase to "record-vs-legacy-200-210:8: set probeRecordRow to {name of probeFontRecord as text,font size of probeFontRecord,bold of probeFontRecord,italic of probeFontRecord,underl"
log probePhase
...
set probePhase to "record-vs-legacy-200-210:9: set probeLegacyJson to my jsonRows({probeLegacyRow})"
log probePhase
set probeLegacyJson to my jsonRows({probeLegacyRow})
set probePhase to "record-vs-legacy-200-210:10: set probeRecordJson to my jsonRows({probeRecordRow})"
log probePhase
set probeRecordJson to my jsonRows({probeRecordRow})
set probePhase to "record-vs-legacy-200-210:11: set probeEqual to (current application's NSString's stringWithString:probeLegacyJson)'s isEqualToString:probeRecordJson"
log probePhase
set probeEqual to (current application's NSString's stringWithString:probeLegacyJson)'s isEqualToString:probeRecordJson
set probePhase to "record-vs-legacy-200-210:12: if not (probeEqual as boolean) then error \"RECORD_VALUE_MISMATCH\""
log probePhase
if not (probeEqual as boolean) then error "RECORD_VALUE_MISMATCH"
set probePhase to "record-vs-legacy-200-210:13: set end of probeRows to {\"same-coordinate\",probePosition as integer,probeEqual as boolean,probeLegacyRow}"
log probePhase
