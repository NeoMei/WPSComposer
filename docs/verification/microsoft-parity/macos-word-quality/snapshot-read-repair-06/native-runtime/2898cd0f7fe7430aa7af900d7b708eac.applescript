...
try
set probePhase to "primary-header-evaluated-class:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "primary-header-evaluated-class:1: set probeStoryRange to get story range boundDoc story type primary header story"
log probePhase
set probeStoryRange to get story range boundDoc story type primary header story
set probePhase to "primary-header-evaluated-class:2: set probeStoryRange to get probeStoryRange"
log probePhase
set probeStoryRange to get probeStoryRange
set probePhase to "primary-header-evaluated-class:3: set probeRows to {{\"class\",(class of probeStoryRange) as text}}"
log probePhase
set probeRows to {{"class",(class of probeStoryRange) as text}}
