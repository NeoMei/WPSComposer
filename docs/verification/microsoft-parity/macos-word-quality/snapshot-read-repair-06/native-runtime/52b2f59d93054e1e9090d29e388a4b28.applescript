...
try
set probePhase to "main-text-original-class:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "main-text-original-class:1: set probeStoryRange to get story range boundDoc story type main text story"
log probePhase
set probeStoryRange to get story range boundDoc story type main text story
set probePhase to "main-text-original-class:2: set probeRows to {{\"class\",(class of probeStoryRange) as text}}"
log probePhase
