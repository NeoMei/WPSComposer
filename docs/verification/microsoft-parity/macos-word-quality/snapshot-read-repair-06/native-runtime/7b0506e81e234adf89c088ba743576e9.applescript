...
try
set probePhase to "primary-header-evaluated-end:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "primary-header-evaluated-end:1: set probeStoryRange to get story range boundDoc story type primary header story"
log probePhase
set probeStoryRange to get story range boundDoc story type primary header story
set probePhase to "primary-header-evaluated-end:2: set probeStoryRange to get probeStoryRange"
log probePhase
set probeStoryRange to get probeStoryRange
set probePhase to "primary-header-evaluated-end:3: set probeValue to \"unresolved-sentinel\""
log probePhase
set probeValue to "unresolved-sentinel"
set probePhase to "primary-header-evaluated-end:4: set probeValue to get end of content of probeStoryRange"
log probePhase
set probeValue to get end of content of probeStoryRange
set probePhase to "primary-header-evaluated-end:5: set probeValueClass to (class of probeValue) as text"
log probePhase
set probeValueClass to (class of probeValue) as text
set probePhase to "primary-header-evaluated-end:6: set probeRows to {{\"scalar\",probeValueClass,probeValue as integer}}"
log probePhase
