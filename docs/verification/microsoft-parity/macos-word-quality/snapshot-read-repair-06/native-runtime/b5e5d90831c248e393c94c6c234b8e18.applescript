...
try
set probePhase to "primary-header-original-start:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "primary-header-original-start:1: set probeStoryRange to get story range boundDoc story type primary header story"
log probePhase
set probeStoryRange to get story range boundDoc story type primary header story
set probePhase to "primary-header-original-start:2: set probeValue to \"unresolved-sentinel\""
log probePhase
set probeValue to "unresolved-sentinel"
set probePhase to "primary-header-original-start:3: set probeValue to get start of content of probeStoryRange"
log probePhase
set probeValue to get start of content of probeStoryRange
set probePhase to "primary-header-original-start:4: set probeValueClass to (class of probeValue) as text"
log probePhase
set probeValueClass to (class of probeValue) as text
set probePhase to "primary-header-original-start:5: set probeRows to {{\"scalar\",probeValueClass,probeValue as integer}}"
log probePhase
