...
try
set probePhase to "font-record-0:0: set probeRange to create range boundDoc start 0 end 1"
log probePhase
set probeRange to create range boundDoc start 0 end 1
set probePhase to "font-record-0:1: set probeFontRecord to get properties of font object of probeRange"
log probePhase
set probeFontRecord to get properties of font object of probeRange
set probePhase to "font-record-0:2: set probeRecordClass to class of probeFontRecord as text"
log probePhase
set probeRecordClass to class of probeFontRecord as text
set probePhase to "font-record-0:3: set probeRows to {{\"font-record\",probeRecordClass,name of probeFontRecord as text,font size of probeFontRecord as real,bold of probeFontReco"
log probePhase
