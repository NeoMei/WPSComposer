...
try
set probePhase to "bulk-start:0: set probeValues to \"unresolved-sentinel\""
log probePhase
set probeValues to "unresolved-sentinel"
set probePhase to "bulk-start:1: set probeValues to get start of content of every character of text object of boundDoc"
log probePhase
set probeValues to get start of content of every character of text object of boundDoc
set probePhase to "bulk-start:2: set probeVectorClass to (class of probeValues) as text"
log probePhase
set probeVectorClass to (class of probeValues) as text
set probePhase to "bulk-start:3: if class of probeValues is not list then error \"BULK_VALUES_NOT_LIST\""
log probePhase
if class of probeValues is not list then error "BULK_VALUES_NOT_LIST"
set probePhase to "bulk-start:4: set probeScalarValues to {}"
log probePhase
set probeScalarValues to {}
set probePhase to "bulk-start:5: repeat with probeValueOrdinal from 1 to count probeValues"
log probePhase
repeat with probeValueOrdinal from 1 to count probeValues
set probePhase to "bulk-start:6: set probeValue to item probeValueOrdinal of probeValues"
log probePhase
set probeValue to item probeValueOrdinal of probeValues
set probePhase to "bulk-start:7: set end of probeScalarValues to probeValue as integer"
log probePhase
set end of probeScalarValues to probeValue as integer
end repeat
set probePhase to "bulk-start:9: set probeRows to {{\"vector\",probeVectorClass,(count probeScalarValues) as integer,probeScalarValues}}"
log probePhase
