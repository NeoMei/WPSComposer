...
try
set probePhase to "bulk-color:0: set probeValues to \"unresolved-sentinel\""
log probePhase
set probeValues to "unresolved-sentinel"
set probePhase to "bulk-color:1: set probeValues to get color of font object of every character of text object of boundDoc"
log probePhase
set probeValues to get color of font object of every character of text object of boundDoc
set probePhase to "bulk-color:2: set probeVectorClass to (class of probeValues) as text"
log probePhase
set probeVectorClass to (class of probeValues) as text
set probePhase to "bulk-color:3: if class of probeValues is not list then error \"BULK_VALUES_NOT_LIST\""
log probePhase
if class of probeValues is not list then error "BULK_VALUES_NOT_LIST"
set probePhase to "bulk-color:4: set probeScalarValues to {}"
log probePhase
set probeScalarValues to {}
set probePhase to "bulk-color:5: repeat with probeValueOrdinal from 1 to count probeValues"
log probePhase
repeat with probeValueOrdinal from 1 to count probeValues
set probePhase to "bulk-color:6: set probeValue to item probeValueOrdinal of probeValues"
log probePhase
set probeValue to item probeValueOrdinal of probeValues
set probePhase to "bulk-color:7: if class of probeValue is not list then error \"BULK_RGB_NOT_LIST\""
log probePhase
if class of probeValue is not list then error "BULK_RGB_NOT_LIST"
set probePhase to "bulk-color:8: set probeRgbValues to {}"
log probePhase
set probeRgbValues to {}
set probePhase to "bulk-color:9: repeat with probeRgbOrdinal from 1 to count probeValue"
log probePhase
repeat with probeRgbOrdinal from 1 to count probeValue
set probePhase to "bulk-color:10: set end of probeRgbValues to item probeRgbOrdinal of probeValue as integer"
log probePhase
set end of probeRgbValues to item probeRgbOrdinal of probeValue as integer
end repeat
set probePhase to "bulk-color:12: set end of probeScalarValues to probeRgbValues"
log probePhase
set end of probeScalarValues to probeRgbValues
end repeat
set probePhase to "bulk-color:14: set probeRows to {{\"vector\",probeVectorClass,(count probeScalarValues) as integer,probeScalarValues}}"
log probePhase
