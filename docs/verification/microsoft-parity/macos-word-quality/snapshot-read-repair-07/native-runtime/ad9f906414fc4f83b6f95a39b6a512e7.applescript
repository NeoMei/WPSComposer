...
try
set probePhase to "font-record-110:0: set probeRange to create range boundDoc start 110 end 111"
log probePhase
set probeRange to create range boundDoc start 110 end 111
set probePhase to "font-record-110:1: set probeFontRecord to get properties of font object of probeRange"
log probePhase
set probeFontRecord to get properties of font object of probeRange
set probePhase to "font-record-110:2: set probeRecordClass to class of probeFontRecord as text"
log probePhase
set probeRecordClass to class of probeFontRecord as text
set probePhase to "font-record-110:3: set probeRows to {{\"font-record\",probeRecordClass,name of probeFontRecord as text,font size of probeFontRecord as real,bold of probeFontReco"
log probePhase
