...
try
set probePhase to "character-count:0: set probeRows to {{\"count\",(count characters of text object of boundDoc) as integer}}"
log probePhase
set probeRows to {{"count",(count characters of text object of boundDoc) as integer}}
