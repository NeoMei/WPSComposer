...
try
set probePhase to "primary-header-scalar-end:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "primary-header-scalar-end:1: set probeStoryRange to get story range boundDoc story type primary header story"
log probePhase
set probeStoryRange to get story range boundDoc story type primary header story
set probePhase to "primary-header-scalar-end:2: set probeRows to {{\"value\",end of content of probeStoryRange as integer}}"
log probePhase
set probeRows to {{"value",end of content of probeStoryRange as integer}}
