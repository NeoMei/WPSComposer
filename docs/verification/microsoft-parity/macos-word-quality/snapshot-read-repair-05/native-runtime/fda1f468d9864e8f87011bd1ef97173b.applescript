...
try
set probePhase to "primary-header-scalar-field-count:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "primary-header-scalar-field-count:1: set probeStoryRange to get story range boundDoc story type primary header story"
log probePhase
set probeStoryRange to get story range boundDoc story type primary header story
set probePhase to "primary-header-scalar-field-count:2: set probeRows to {{\"value\",(count fields of probeStoryRange) as integer}}"
log probePhase
set probeRows to {{"value",(count fields of probeStoryRange) as integer}}
