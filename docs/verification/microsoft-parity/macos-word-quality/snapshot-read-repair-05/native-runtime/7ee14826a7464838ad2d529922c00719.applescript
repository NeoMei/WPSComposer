...
set probePhase to "story-availability-and-chain:17: set end of qualityLayout to {\"page-story\",\"primary header\",probeStoryOrdinal as integer,content of probeStoryRange as text}"
log probePhase
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:51: set end of qualityLayout to {\"page-story\",\"primary footer\",probeStoryOrdinal as integer,content of probeStoryRange as text}"
log probePhase
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:85: set end of qualityLayout to {\"page-story\",\"first page header\",probeStoryOrdinal as integer,content of probeStoryRange as text}"
log probePhase
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:119: set end of qualityLayout to {\"page-story\",\"first page footer\",probeStoryOrdinal as integer,content of probeStoryRange as text}"
log probePhase
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:153: set end of qualityLayout to {\"page-story\",\"even pages header\",probeStoryOrdinal as integer,content of probeStoryRange as text}"
log probePhase
...
log probePhase
if probeStoryOrdinal > 10000 then error "WPSC_STORY_CHAIN_INVALID"
set probePhase to "story-availability-and-chain:187: set end of qualityLayout to {\"page-story\",\"even pages footer\",probeStoryOrdinal as integer,content of probeStoryRange as text}"
log probePhase
