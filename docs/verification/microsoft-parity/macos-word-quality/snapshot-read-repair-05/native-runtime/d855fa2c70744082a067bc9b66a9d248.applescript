...
try
set probePhase to "primary-header-scalar-content:0: set probeStoryRange to missing value"
log probePhase
set probeStoryRange to missing value
set probePhase to "primary-header-scalar-content:1: set probeStoryRange to get story range boundDoc story type primary header story"
log probePhase
set probeStoryRange to get story range boundDoc story type primary header story
set probePhase to "primary-header-scalar-content:2: set probeRows to {{\"value\",content of probeStoryRange as text}}"
log probePhase
set probeRows to {{"value",content of probeStoryRange as text}}
