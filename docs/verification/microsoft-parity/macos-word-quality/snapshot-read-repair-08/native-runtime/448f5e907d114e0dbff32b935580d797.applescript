...
try
set probePhase to "record-vs-legacy-59:0: set probeRange to create range boundDoc start 59 end 60"
log probePhase
set probeRange to create range boundDoc start 59 end 60
set probePhase to "record-vs-legacy-59:1: set probeFontReference to font object of probeRange"
log probePhase
set probeFontReference to font object of probeRange
set probePhase to "record-vs-legacy-59:2: set probeLegacyRow to {name of probeFontReference as text,font size of probeFontReference as real,bold of probeFontReference as boolean,ital"
log probePhase
...
set probePhase to "record-vs-legacy-59:3: set probeFontRecord to (get properties of font object of probeRange) as record"
log probePhase
set probeFontRecord to (get properties of font object of probeRange) as record
set probePhase to "record-vs-legacy-59:4: set probeShadingRecord to (get properties of shading of probeRange) as record"
log probePhase
set probeShadingRecord to (get properties of shading of probeRange) as record
set probePhase to "record-vs-legacy-59:5: set probeRecordRow to {name of probeFontRecord as text,font size of probeFontRecord as real,bold of probeFontRecord as boolean,italic of pro"
log probePhase
...
set probePhase to "record-vs-legacy-59:6: set probeLegacyJson to my jsonRows({probeLegacyRow})"
log probePhase
set probeLegacyJson to my jsonRows({probeLegacyRow})
set probePhase to "record-vs-legacy-59:7: set probeRecordJson to my jsonRows({probeRecordRow})"
log probePhase
set probeRecordJson to my jsonRows({probeRecordRow})
set probePhase to "record-vs-legacy-59:8: set probeEqual to (current application's NSString's stringWithString:probeLegacyJson)'s isEqualToString:probeRecordJson"
log probePhase
set probeEqual to (current application's NSString's stringWithString:probeLegacyJson)'s isEqualToString:probeRecordJson
set probePhase to "record-vs-legacy-59:9: set probeRows to {{\"same-coordinate\",59,probeEqual as boolean,probeLegacyRow,probeRecordRow}}"
log probePhase
set probeRows to {{"same-coordinate",59,probeEqual as boolean,probeLegacyRow,probeRecordRow}}
