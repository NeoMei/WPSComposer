...
try
set probePhase to "table-2-dimensions:0: set qt to table 2 of boundDoc"
log probePhase
set qt to table 2 of boundDoc
set probePhase to "table-2-dimensions:1: set probeRows to {{\"dimensions\",(count rows of qt) as integer,(count columns of qt) as integer}}"
log probePhase
set probeRows to {{"dimensions",(count rows of qt) as integer,(count columns of qt) as integer}}
