...
try
set probePhase to "table-2-ordinal-rows:0: set qt to table 2 of boundDoc"
log probePhase
set qt to table 2 of boundDoc
set probePhase to "table-2-ordinal-rows:1: repeat with probeRowOrdinal from 1 to count rows of qt"
log probePhase
repeat with probeRowOrdinal from 1 to count rows of qt
set probePhase to "table-2-ordinal-rows:2: set qrow to row probeRowOrdinal of qt"
log probePhase
set qrow to row probeRowOrdinal of qt
set probePhase to "table-2-ordinal-rows:3: set probeFlag to allow break across pages of qrow"
log probePhase
set probeFlag to allow break across pages of qrow
set probePhase to "table-2-ordinal-rows:4: set end of probeRows to {\"row\",probeRowOrdinal as integer,probeFlag}"
log probePhase
