...
try
set probePhase to "table-1-dimensions:0: set qt to table 1 of boundDoc"
log probePhase
set qt to table 1 of boundDoc
set probePhase to "table-1-dimensions:1: set probeRows to {{\"dimensions\",(count rows of qt) as integer,(count columns of qt) as integer}}"
log probePhase
