...
try
set probePhase to "style-name-list:0: set probeNames to get name local of every Word style of boundDoc"
log probePhase
set probeNames to get name local of every Word style of boundDoc
set probePhase to "style-name-list:1: set probeRows to {{\"names\",probeNames}}"
log probePhase
set probeRows to {{"names",probeNames}}
