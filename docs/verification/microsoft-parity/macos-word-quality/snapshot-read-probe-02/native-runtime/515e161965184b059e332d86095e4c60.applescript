...
try
set probePhase to "table-1-bounds:0: set qt to table 1 of boundDoc"
log probePhase
set qt to table 1 of boundDoc
set probePhase to "table-1-bounds:1: set qr to text object of qt"
log probePhase
set qr to text object of qt
set probePhase to "table-1-bounds:2: set probeRows to {{\"bounds\",start of content of qr,end of content of qr}}"
log probePhase
