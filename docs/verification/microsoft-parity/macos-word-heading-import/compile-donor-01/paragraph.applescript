...
set tabsEqual to ((count tab stops of sourceParagraph) is (count tab stops of destinationParagraph))
if tabsEqual then
repeat with i from 1 to count tab stops of sourceParagraph
set sourceTab to tab stop i of sourceParagraph
set destinationTab to tab stop i of destinationParagraph
...
set end of nativeRows to {"paragraph:tabs",tabsEqual}
