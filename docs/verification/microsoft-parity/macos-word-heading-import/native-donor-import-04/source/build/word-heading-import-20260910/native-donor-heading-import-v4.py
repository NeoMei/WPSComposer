"""V4 bounded donor import acceptance with same-text native style controls.
...
SOURCES=[Path(__file__),Path(__file__).with_name('test_native_donor_heading_import_v4.py'),
