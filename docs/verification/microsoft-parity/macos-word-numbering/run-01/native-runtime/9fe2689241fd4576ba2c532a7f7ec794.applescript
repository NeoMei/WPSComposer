...
set identityRange to text object of bookmark "WPSC_N_f39aad095aaa4987a3b159b5e66ba0" of boundDoc
if (content of identityRange as text) is not " SEQ WPSC_EQ \\* ARABIC \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_N_f39aad095aaa4987a3b159b5e66ba0",start of content of identityRange}
if not (exists bookmark "WPSC_N_20674658b43f4b6c8eb8cc3f817a7d" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_N_20674658b43f4b6c8eb8cc3f817a7d" of boundDoc
if (content of identityRange as text) is not " STYLEREF \"标题 1\" \\s \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_N_20674658b43f4b6c8eb8cc3f817a7d",start of content of identityRange}
if not (exists bookmark "WPSC_N_8d9731ad50e8498f9efcd28149a752" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_N_8d9731ad50e8498f9efcd28149a752" of boundDoc
if (content of identityRange as text) is not " SEQ WPSC_FIG \\* ARABIC \\s 1 \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_N_8d9731ad50e8498f9efcd28149a752",start of content of identityRange}
if not (exists bookmark "WPSC_N_09c925f5e5b346faab7977f2afdbf9" of boundDoc) then error "WPSC_FIELD_IDENTITY_STALE"
set identityRange to text object of bookmark "WPSC_N_09c925f5e5b346faab7977f2afdbf9" of boundDoc
if (content of identityRange as text) is not " SEQ WPSC_EQ \\* ARABIC \\* MERGEFORMAT " then error "WPSC_FIELD_IDENTITY_STALE"
set end of nativeRows to {"identity","WPSC_N_09c925f5e5b346faab7977f2afdbf9",start of content of identityRange}
