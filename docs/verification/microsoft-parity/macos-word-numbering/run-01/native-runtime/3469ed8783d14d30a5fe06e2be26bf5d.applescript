...
set numberRange to create range boundDoc start 64 end 64
set content of numberRange to "" & return & ""
set numberRange to create range boundDoc start 64 end 65
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 65
set selection end of numberSelection to 65
