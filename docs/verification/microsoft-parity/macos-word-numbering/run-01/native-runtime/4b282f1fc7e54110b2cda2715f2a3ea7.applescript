...
set content of text object of qualitySentinel to "NUMBERING SENTINEL 中文😀 322363aa607d4bf0a12983b2bc9de3d7"
activate object (active window of qualitySentinel)
set nativeRows to {{name of qualitySentinel as text}}
end tell
end timeout
