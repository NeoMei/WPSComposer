...
set numberRange to create range boundDoc start 20 end 62
make new bookmark at boundDoc with properties {name:"wpsc_eq_aaaaaaaaaaaaaaaaaaaaaaaa",text object:numberRange}
set numberBookmark to bookmark "wpsc_eq_aaaaaaaaaaaaaaaaaaaaaaaa" of boundDoc
