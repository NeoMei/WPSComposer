...
if (start of content of numberSelectionRange) is not 65 or (end of content of numberSelectionRange) is not 65 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 65 end 65
set content of numberRange to "fallback"
set numberRange to create range boundDoc start 65 end 73
