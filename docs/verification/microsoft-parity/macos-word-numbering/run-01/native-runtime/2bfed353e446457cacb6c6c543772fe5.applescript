...
if (start of content of numberSelectionRange) is not 164 or (end of content of numberSelectionRange) is not 164 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 164 end 164
set content of numberRange to "" & return & ""
set numberRange to create range boundDoc start 164 end 165
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 165
set selection end of numberSelection to 165
