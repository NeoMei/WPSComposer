...
if (start of content of numberSelectionRange) is not 114 or (end of content of numberSelectionRange) is not 114 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 114 end 114
set content of numberRange to "-"
set numberRange to create range boundDoc start 114 end 115
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 115
set selection end of numberSelection to 115
