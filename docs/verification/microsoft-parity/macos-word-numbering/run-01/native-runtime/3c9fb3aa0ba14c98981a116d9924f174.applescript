...
if (start of content of numberSelectionRange) is not 166 or (end of content of numberSelectionRange) is not 166 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 166 end 166
set content of numberRange to "" & tab & ""
set numberRange to create range boundDoc start 166 end 167
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 167
set selection end of numberSelection to 167
