...
if (start of content of numberSelectionRange) is not 13 or (end of content of numberSelectionRange) is not 20 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 13 end 20
set content of numberRange to "x=1"
set numberRange to create range boundDoc start 13 end 16
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 16
set selection end of numberSelection to 16
