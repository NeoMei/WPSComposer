...
if (start of content of numberSelectionRange) is not 413 or (end of content of numberSelectionRange) is not 413 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 413 end 413
set content of numberRange to "REMOVED"
set numberRange to create range boundDoc start 413 end 420
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 420
set selection end of numberSelection to 420
