...
if (start of content of numberSelectionRange) is not 210 or (end of content of numberSelectionRange) is not 210 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 168 end 210
make new bookmark at boundDoc with properties {name:"wpsc_eq_cccccccccccccccccccccccc",text object:numberRange}
set numberBookmark to bookmark "wpsc_eq_cccccccccccccccccccccccc" of boundDoc
