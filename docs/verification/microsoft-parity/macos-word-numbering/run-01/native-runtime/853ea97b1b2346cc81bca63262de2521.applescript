...
set numberRange to create range boundDoc start 210 end 210
set content of numberRange to ")"
set numberRange to create range boundDoc start 210 end 211
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 211
set selection end of numberSelection to 211
