...
if (start of content of numberSelectionRange) is not 16 or (end of content of numberSelectionRange) is not 16 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 16 end 16
set content of numberRange to "" & tab & ""
set numberRange to create range boundDoc start 16 end 17
