...
if (start of content of numberSelectionRange) is not 422 or (end of content of numberSelectionRange) is not 422 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberBefore to count fields of boundDoc
set numberRange to create range boundDoc start 422 end 422
create new field text range numberRange field type field sequence field text "WPSC_EQ \\* ARABIC" preserve formatting true
...
if (start of content of field code of numberCandidate) is 423 then
...
make new bookmark at boundDoc with properties {name:"WPSC_N_a52488338544419d85713f12f25a2b",text object:field code of numberField}
set numberIdentity to text object of bookmark "WPSC_N_a52488338544419d85713f12f25a2b" of boundDoc
set selection start of numberSelection to numberNext
set selection end of numberSelection to numberNext
set nativeRows to {{"field",numberBefore,numberAfter,numberCodeStart,numberCodeEnd,numberResultStart,numberResultEnd,numberCode,"WPSC_N_a52488338544419d85713f12f25a2b",start of content of numberIdentity,end of content of numberIdentity,content of numberIdentity as text}}
end tell
end timeout
