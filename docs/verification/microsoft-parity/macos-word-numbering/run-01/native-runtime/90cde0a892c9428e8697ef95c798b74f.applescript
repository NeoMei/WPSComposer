...
if (start of content of numberSelectionRange) is not 420 or (end of content of numberSelectionRange) is not 420 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 420 end 420
set content of numberRange to "" & tab & ""
set numberRange to create range boundDoc start 420 end 421
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 421
set selection end of numberSelection to 421
