...
if (start of content of numberSelectionRange) is not 74 or (end of content of numberSelectionRange) is not 74 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 74 end 74
set content of numberRange to "["
set numberRange to create range boundDoc start 74 end 75
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 75
set selection end of numberSelection to 75
