...
if (start of content of numberSelectionRange) is not 20 or (end of content of numberSelectionRange) is not 20 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberBefore to count fields of boundDoc
set numberRange to create range boundDoc start 20 end 20
...
if (start of content of field code of numberCandidate) is 21 then
...
make new bookmark at boundDoc with properties {name:"WPSC_N_f39aad095aaa4987a3b159b5e66ba0",text object:field code of numberField}
set numberIdentity to text object of bookmark "WPSC_N_f39aad095aaa4987a3b159b5e66ba0" of boundDoc
set selection start of numberSelection to numberNext
set selection end of numberSelection to numberNext
set nativeRows to {{"field",numberBefore,numberAfter,numberCodeStart,numberCodeEnd,numberResultStart,numberResultEnd,numberCode,"WPSC_N_f39aad095aaa4987a3b159b5e66ba0",start of content of numberIdentity,end of content of numberIdentity,content of numberIdentity as text}}
end tell
end timeout
