...
if (start of content of numberSelectionRange) is not 167 or (end of content of numberSelectionRange) is not 167 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 167 end 167
set content of numberRange to "("
set numberRange to create range boundDoc start 167 end 168
