...
if (start of content of numberSelectionRange) is not 75 or (end of content of numberSelectionRange) is not 75 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberBefore to count fields of boundDoc
set numberRange to create range boundDoc start 75 end 75
...
if (start of content of field code of numberCandidate) is 76 then
...
make new bookmark at boundDoc with properties {name:"WPSC_N_20674658b43f4b6c8eb8cc3f817a7d",text object:field code of numberField}
set numberIdentity to text object of bookmark "WPSC_N_20674658b43f4b6c8eb8cc3f817a7d" of boundDoc
set selection start of numberSelection to numberNext
set selection end of numberSelection to numberNext
set nativeRows to {{"field",numberBefore,numberAfter,numberCodeStart,numberCodeEnd,numberResultStart,numberResultEnd,numberCode,"WPSC_N_20674658b43f4b6c8eb8cc3f817a7d",start of content of numberIdentity,end of content of numberIdentity,content of numberIdentity as text}}
end tell
end timeout
