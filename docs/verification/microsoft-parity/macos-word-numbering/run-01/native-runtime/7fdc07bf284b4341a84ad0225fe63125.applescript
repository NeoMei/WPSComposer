...
if (start of content of numberSelectionRange) is not 165 or (end of content of numberSelectionRange) is not 165 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 165 end 165
set content of numberRange to "7"
set numberRange to create range boundDoc start 165 end 166
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 166
set selection end of numberSelection to 166
