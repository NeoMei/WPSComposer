...
set numberRange to create range boundDoc start 75 end 163
make new bookmark at boundDoc with properties {name:"wpsc_eq_bbbbbbbbbbbbbbbbbbbbbbbb",text object:numberRange}
set numberBookmark to bookmark "wpsc_eq_bbbbbbbbbbbbbbbbbbbbbbbb" of boundDoc
