...
set np to (end of content of text object of boundDoc) - 1
set selection start of selection of boundWindow to np
set selection end of selection of boundWindow to np
