...
if (start of content of numberSelectionRange) is not 211 or (end of content of numberSelectionRange) is not 211 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberRange to create range boundDoc start 211 end 211
set content of numberRange to "" & return & ""
set numberRange to create range boundDoc start 211 end 212
set numberText to content of numberRange
if numberText is missing value then set numberText to ""
set selection start of numberSelection to 212
set selection end of numberSelection to 212
