...
if (start of content of numberSelectionRange) is not 115 or (end of content of numberSelectionRange) is not 115 then error "WPSC_NUMBERING_SELECTION_CHANGED"
set numberBefore to count fields of boundDoc
set numberRange to create range boundDoc start 115 end 115
create new field text range numberRange field type field sequence field text "WPSC_FIG \\* ARABIC \\s 1" preserve formatting true
...
if (start of content of field code of numberCandidate) is 116 then
...
make new bookmark at boundDoc with properties {name:"WPSC_N_8d9731ad50e8498f9efcd28149a752",text object:field code of numberField}
set numberIdentity to text object of bookmark "WPSC_N_8d9731ad50e8498f9efcd28149a752" of boundDoc
set selection start of numberSelection to numberNext
set selection end of numberSelection to numberNext
set nativeRows to {{"field",numberBefore,numberAfter,numberCodeStart,numberCodeEnd,numberResultStart,numberResultEnd,numberCode,"WPSC_N_8d9731ad50e8498f9efcd28149a752",start of content of numberIdentity,end of content of numberIdentity,content of numberIdentity as text}}
end tell
end timeout
