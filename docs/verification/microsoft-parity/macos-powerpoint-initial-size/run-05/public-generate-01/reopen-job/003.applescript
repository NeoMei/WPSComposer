...
on sessionOperation()
set pdfHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-ubymaa9h/export-45d0528ae139477fbe22741fa26293ea.pdf") as text
with timeout of 39 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-936a1b943c834e3a9aaac021c70011a7.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-936a1b943c834e3a9aaac021c70011a7.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-ubymaa9h/bound-936a1b943c834e3a9aaac021c70011a7.pptx" then error "Bound presentation path changed"
