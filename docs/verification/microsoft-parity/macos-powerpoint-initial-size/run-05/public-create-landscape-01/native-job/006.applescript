...
set currentShape to make new shape at end of targetSlide with properties {name:"wpscomposer-3441c574e8ac4da19ca125adc2866e47",left position:40,top:110,width:180,height:60,auto shape type:autoshape rectangle}
set visible of fill format of currentShape to true
set fore color of fill format of currentShape to {36, 99, 166}
set transparency of line format of currentShape to 1
set content of text range of text frame of currentShape to "Native rectangle"
set font size of font of text range of text frame of currentShape to 14
return "CREATED"
 end tell
end timeout
