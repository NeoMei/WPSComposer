...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-f44eebd927064bdd97e34349090e5adb.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-f44eebd927064bdd97e34349090e5adb.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-k1qx3qdi/bound-f44eebd927064bdd97e34349090e5adb.pptx" then error "Bound presentation path changed"
set targetSlide to slide 1 of ownedDoc
set currentShape to make new text box at end of targetSlide with properties {name:"wpscomposer-125fdf9a60094f3ba9d5201af252a49f",left position:30,top:30,width:260,height:40}
