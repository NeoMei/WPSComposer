...
on sessionOperation()
with timeout of 86 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-e95b7bd2264b44ba963bfed5ef9ed6c0.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-e95b7bd2264b44ba963bfed5ef9ed6c0.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-uejqqk1t/bound-e95b7bd2264b44ba963bfed5ef9ed6c0.pptx" then error "Bound presentation path changed"
set targetSlide to slide 1 of ownedDoc
set currentShape to make new text box at end of targetSlide with properties {name:"wpscomposer-9eaca166f49742969dbee20691bd345b",left position:30,top:30,width:260,height:40}
set content of text range of text frame of currentShape to "Public create 720 x 405"
