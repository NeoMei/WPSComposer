...
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-390f155011454a068959830a7da1804d.pptx" then set identityCount to identityCount + 1
end repeat
...
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-9bv_bx_h/bound-390f155011454a068959830a7da1804d.pptx" then error "Bound presentation path changed"
