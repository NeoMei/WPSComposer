...
on sessionOperation()
set inputFile to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-9bv_bx_h/bound-390f155011454a068959830a7da1804d.pptx") as alias
with timeout of 44 seconds
 tell application "Microsoft PowerPoint"
if exists presentation "bound-390f155011454a068959830a7da1804d.pptx" then error "Presentation collision"
open inputFile
set ownedDoc to presentation "bound-390f155011454a068959830a7da1804d.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-9bv_bx_h/bound-390f155011454a068959830a7da1804d.pptx" then error "Owned path mismatch"
return "OPEN"
 end tell
end timeout
