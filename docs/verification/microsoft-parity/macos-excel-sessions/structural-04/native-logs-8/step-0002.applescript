...
set ownedBook to workbook "owned-2cc1f72935a44ba99759667f8e8aa74d.xlsx"
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-dxhxlc67/owned-2cc1f72935a44ba99759667f8e8aa74d.xlsx" then error "Owned workbook identity mismatch"
set sheetJSONs to {}
...
set resultJSON to "{" & "\"kind\":" & my j("sheet") & ",\"name\":" & my j(name of ownedBook) & ",\"path\":" & my j("/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel-sessions/structural-04/structural.xlsx") & ",\"saved\":" & my j(saved of ownedBook) & ",\"sheet_count\":" & my j(count of worksheets of ownedBook) & ",\"cells_truncated\":" & my j(truncated) & "}"
