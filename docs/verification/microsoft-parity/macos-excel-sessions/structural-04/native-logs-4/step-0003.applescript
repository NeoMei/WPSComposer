...
copy range (entire column of obj)
insert into range (range "E:E" of ws)
set cut copy mode to false
return "{" & "\"type\":" & my j("column") & ",\"cloned\":" & my j(true) & ",\"from\":" & my j("sheet:1/range:B2:D4") & ",\"column\":" & my j(5) & ",\"clipboard_changed\":" & my j(true) & ",\"requested_index\":" & my j(5) & "}"
 end tell
end timeout
