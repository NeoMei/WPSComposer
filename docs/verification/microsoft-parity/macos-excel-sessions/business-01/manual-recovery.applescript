...
set b to workbook "owned-48e514c56b754f01998aec0041e08361.xlsx"
if full name of b is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-y645z5k7/owned-48e514c56b754f01998aec0041e08361.xlsx" then error "Owned identity mismatch"
save b
close b saving no
set resultText to ""
...
if documentPath starts with "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-y645z5k7/" then error "Owned document still open"
end repeat
return resultText
end tell
end timeout