...
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-active-fixture-p_6dge6p/active-owned.xlsx" then error "Owned workbook identity mismatch"
if full name of active workbook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-active-fixture-p_6dge6p/active-owned.xlsx" then error "Active workbook changed before inspection"
...
set resultJSON to "{" & "\"kind\":" & my j("sheet") & ",\"name\":" & my j(name of ownedBook) & ",\"path\":" & my j("/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-active-fixture-p_6dge6p/active-owned.xlsx") & ",\"saved\":" & my j(saved of ownedBook) & ",\"sheet_count\":" & my j(count of worksheets of ownedBook) & ",\"cells_truncated\":" & my j(truncated) & "}"
activate object worksheet originalSheetName of ownedBook
...
if full name of ownedBook is "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-active-fixture-p_6dge6p/active-owned.xlsx" then
activate object worksheet originalSheetName of ownedBook
select range originalSelectionAddress of worksheet originalSheetName of ownedBook
end if
end if
