...
set resultingSheetName to missing value
repeat with candidateName in (name of every worksheet of ownedBook)
 if (contents of candidateName) is not in beforeSheetNames then set resultingSheetName to contents of candidateName
end repeat
if resultingSheetName is missing value then error "Cloned worksheet identity missing"
