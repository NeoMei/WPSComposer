...
if full name of b is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-active-fixture-2c8jri01/active-owned.xlsx" then error "Owned identity mismatch"
save b
close b saving no
set resultText to ""
...
if documentPath starts with "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-active-fixture-2c8jri01/" then error "Owned document still open"
end repeat
return resultText
end tell
end timeout