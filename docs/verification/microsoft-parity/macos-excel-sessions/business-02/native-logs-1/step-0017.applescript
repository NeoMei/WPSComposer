...
activate object ws
set obj to range "B2:B3" of ws
delete format conditions of obj
make new format condition at obj with properties {format condition type:cell value, condition operator:operator greater, formula 1:"15"}
set color of interior object of format condition 1 of obj to {255, 199, 206}
return "{" & "\"condition_count\":" & my j(count of format conditions of obj) & "}"
 end tell
end timeout
