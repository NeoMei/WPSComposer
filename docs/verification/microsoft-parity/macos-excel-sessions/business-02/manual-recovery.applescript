...
set b to workbook "owned-2f80ba90bdd84884a149c1f44a036ecb.xlsx"
if full name of b is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-us27yjva/owned-2f80ba90bdd84884a149c1f44a036ecb.xlsx" then error "Owned identity mismatch"
save b
close b saving no
set resultText to ""
...
if documentPath starts with "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-us27yjva/" then error "Owned document still open"
end repeat
return resultText
end tell
end timeout