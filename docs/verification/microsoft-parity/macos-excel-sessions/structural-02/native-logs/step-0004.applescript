...
insert into range (range "C:C" of ws)
return "{" & "\"type\":" & my j("column") & ",\"cloned\":" & my j(true) & ",\"from\":" & my j("sheet:1/cell:B1") & ",\"column\":" & my j(3) & ",\"clipboard_changed\":" & my j(true) & ",\"requested_index\":" & my j(3) & "}"
 end tell
end timeout
