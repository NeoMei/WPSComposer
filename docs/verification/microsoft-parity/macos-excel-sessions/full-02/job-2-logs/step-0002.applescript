...
set ownedBook to workbook "owned-91cbc82427cd4937818d7c37b8e63972.xlsx"
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-g46on2qb/owned-91cbc82427cd4937818d7c37b8e63972.xlsx" then error "Owned workbook identity mismatch"
set sheetJSONs to {}
...
set resultJSON to "{" & "\"kind\":" & my j("sheet") & ",\"name\":" & my j(name of ownedBook) & ",\"path\":" & my j("/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel-sessions/full-02/edited.xlsx") & ",\"saved\":" & my j(saved of ownedBook) & ",\"sheet_count\":" & my j(count of worksheets of ownedBook) & ",\"cells_truncated\":" & my j(truncated) & "}"
