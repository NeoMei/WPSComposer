...
set acceptedKeys to {}
set rejectedKeys to {}
set name of obj to "Results"
set end of acceptedKeys to "name"
set page orientation of page setup object of obj to landscape
set end of acceptedKeys to "page_setup.orientation"
set top margin of page setup object of obj to 40
set end of acceptedKeys to "page_setup.top_margin"
set print area of page setup object of obj to "$A$1:$D$4"
set end of acceptedKeys to "page_setup.print_area"
