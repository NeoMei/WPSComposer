...
set ownedBook to workbook "owned-e145a09d9a974b9eaf351722bd3ffb09.xlsx"
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-tnbqumki/owned-e145a09d9a974b9eaf351722bd3ffb09.xlsx" then error "Owned workbook identity mismatch"
set ws to worksheet 2 of ownedBook
activate object ws
set obj to ws
if (count of worksheets of ownedBook) <= 1 then error "Cannot remove last worksheet"
delete obj
return "{" & "\"removed\":" & my j("sheet:2") & "}"
 end tell
end timeout
