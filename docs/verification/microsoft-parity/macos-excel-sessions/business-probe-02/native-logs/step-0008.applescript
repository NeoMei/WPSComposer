...
activate object ws
set obj to range "D2:D4" of ws
try
make new format condition at end of format conditions of obj with properties {format condition type:cell value, condition operator:operator greater, formula 1:"15"}
return "{" & "\"ok\":" & my j(true) & ",\"count\":" & my j(count of format conditions of obj) & "}"
