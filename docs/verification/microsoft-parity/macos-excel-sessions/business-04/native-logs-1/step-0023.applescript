...
if "Business report" is in (name of every worksheet of ownedBook) then error "Duplicate sheet name"
tell ownedBook
 make new worksheet at end with properties {name:"Business report"}
end tell
