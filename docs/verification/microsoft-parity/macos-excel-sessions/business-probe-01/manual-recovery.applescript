...
set b to workbook "owned-8e328737093b4229975803fbfb36ad5d.xlsx"
if full name of b is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-xshcsl05/owned-8e328737093b4229975803fbfb36ad5d.xlsx" then error "Owned identity mismatch"
save b
close b saving no
set resultText to ""
...
if documentPath starts with "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-xshcsl05/" then error "Owned document still open"
end repeat
return resultText
end tell
end timeout