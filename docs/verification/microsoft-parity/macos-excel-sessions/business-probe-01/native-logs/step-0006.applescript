...
activate object ws
set obj to ws
set left header of page setup object of ws to "NATIVE HEADER"
set center header of page setup object of ws to "&P"
set right header of page setup object of ws to "&D"
set stepResult to "{}"
