...
set ownedBook to workbook "owned-e1f4421472f149f4969be00a10793843.xlsx"
if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/tmp/wpscomposer/session-ie8gpqua/owned-e1f4421472f149f4969be00a10793843.xlsx" then error "Owned workbook identity mismatch"
...
set destinationSheetIndex to count of worksheets of ownedBook
set beforeSheetCount to count of worksheets of ownedBook
copy worksheet obj after worksheet destinationSheetIndex of ownedBook
if (count of worksheets of ownedBook) is not beforeSheetCount + 1 then error "Worksheet clone count mismatch"
set resultingSheetName to name of worksheet (destinationSheetIndex + 1) of ownedBook
set resultingIndex to entry_index of worksheet resultingSheetName of ownedBook
return "{" & "\"type\":" & my j("sheet") & ",\"cloned\":" & my j(true) & ",\"from\":" & my j("sheet:2") & ",\"path\":" & my j("sheet:" & resultingIndex) & "}"
 end tell
end timeout
