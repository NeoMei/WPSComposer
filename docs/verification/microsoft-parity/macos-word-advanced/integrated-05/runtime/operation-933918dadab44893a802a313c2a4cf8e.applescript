...
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-cfx6e21l/advanced.docx" file format format document default add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-cfx6e21l/advanced.docx" then error "Owned document path mismatch"
...
set ownPicture to make new inline picture at beginning of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-cfx6e21l/2d211f2c4d5804c0.png", link to file:false, save with document:true}
...
set ownPicture to make new inline picture at beginning of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-cfx6e21l/9511568f54eeeb65.png", link to file:false, save with document:true}
...
set style of r to style body text
set first line indent of paragraph format of r to 0
set bulletList to make new list template at ownedDoc with properties {outline numbered:false}
set number style of list level 1 of bulletList to list number style bullet
set number format of list level 1 of bulletList to "■"
...
set ownedDoc to document "advanced.docx"
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-cfx6e21l/advanced.docx" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-cfx6e21l/advanced.docx" then error "Cleanup identity is outside this operation"
