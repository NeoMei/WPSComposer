...
with timeout of 161 seconds
 tell application "Microsoft Word"
  ...
  try
   open file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-86cyjtt8/advanced.docx" add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-86cyjtt8/advanced.docx" then error "Owned source path mismatch"
   repaginate ownedDoc
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-86cyjtt8/quality-ecaa2da78d374eda8e31c96c7ac76324.pdf" file format format PDF add to recent files false
set ownedDoc to missing value
repeat with documentIndex from 1 to (count of documents)
 set d to document documentIndex
 if (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-86cyjtt8/advanced.docx") or (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-86cyjtt8/quality-ecaa2da78d374eda8e31c96c7ac76324.pdf") then set ownedDoc to document (name of d)
end repeat
