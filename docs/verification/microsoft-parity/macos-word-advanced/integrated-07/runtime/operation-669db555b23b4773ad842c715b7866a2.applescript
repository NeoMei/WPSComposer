...
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-89iltnsa/advanced.docx" file format format document default add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-89iltnsa/advanced.docx" then error "Owned document path mismatch"
...
set ownPicture to make new inline picture at beginning of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-89iltnsa/2d211f2c4d5804c0.png", link to file:false, save with document:true}
...
set ownPicture to make new inline picture at beginning of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-89iltnsa/9511568f54eeeb65.png", link to file:false, save with document:true}
...
set style of r to style body text
set first line indent of paragraph format of r to 0
set bulletList to make new list template at ownedDoc with properties {name:"WPSCBullet412", outline numbered:true}
set bulletLevel to list level 1 of bulletList
set number style of bulletLevel to list number style bullet
set number format of bulletLevel to "■"
apply list format template (list format of r) list template bulletList continue previous list false apply to list apply to selection
set pendingHeadingStart to missing value
set ownedDoc to document "advanced.docx"
log "WPSC_OP:writer.add_paragraph"
set nodeStart to (end of content of text object of ownedDoc) - 1
...
set ownedDoc to document "advanced.docx"
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-89iltnsa/advanced.docx" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-89iltnsa/advanced.docx" then error "Cleanup identity is outside this operation"
