...
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-qcs0kkqg/primitive.docx" file format format document default add to recent files false
set ownedDoc to document "primitive.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-qcs0kkqg/primitive.docx" then error "Owned document path mismatch"
...
set paragraph format left indent of paragraph format of r to 18
set paragraph format right indent of paragraph format of r to 9
...
save ownedDoc
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-qcs0kkqg/primitive.docx" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-qcs0kkqg/primitive.docx" then error "Cleanup identity is outside this operation"
