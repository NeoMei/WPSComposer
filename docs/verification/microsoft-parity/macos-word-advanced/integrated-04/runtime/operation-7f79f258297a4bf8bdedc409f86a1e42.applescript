...
with timeout of 163 seconds
 tell application "Microsoft Word"
  ...
  try
   open file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/advanced.docx" add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/advanced.docx" then error "Owned source path mismatch"
   repaginate ownedDoc
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/quality-546914655ea841e0a332cbe58307b59f.pdf" file format format PDF add to recent files false
set ownedDoc to missing value
repeat with documentIndex from 1 to (count of documents)
 set d to document documentIndex
 if (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/advanced.docx") or (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/quality-546914655ea841e0a332cbe58307b59f.pdf") then set ownedDoc to document (name of d)
end repeat
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/quality-546914655ea841e0a332cbe58307b59f.pdf" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-x5kazrao/advanced.docx" then error "Cleanup identity is outside this operation"
