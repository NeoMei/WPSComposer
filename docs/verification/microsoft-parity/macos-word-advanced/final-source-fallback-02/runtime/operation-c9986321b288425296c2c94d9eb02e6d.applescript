...
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx" file format format document default add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx" then error "Owned document path mismatch"
...
error "Task-owned injected native math failure"
on error
set s to start of content of text object of formulaCell
set e to (end of content of text object of formulaCell) - 1
set failedMathRange to create range ownedDoc start s end e
delete failedMathRange
set content of text object of formulaCell to "x^2+\\frac{a}{b}"
set formulaFailed to true
log "WPSC_EQUATION_FALLBACK" & tab & "wpsc-eq:1"
end try
...
if formulaFailed then
set r to my appendText(ownedDoc, "[EQUATION_INSERT_FAILED] Native equation failed; readable source retained." & return)
end if
set nodeEnd to (end of content of text object of ownedDoc) - 1
set r to create range ownedDoc start nodeStart end nodeEnd
...
set ownPicture to make new inline picture at beginning of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/2d211f2c4d5804c0.png", link to file:false, save with document:true}
...
set ownPicture to make new inline picture at beginning of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/9511568f54eeeb65.png", link to file:false, save with document:true}
...
set ownedDoc to document "advanced.docx"
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx" then error "Cleanup identity is outside this operation"
