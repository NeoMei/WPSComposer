...
with timeout of 163 seconds
 tell application "Microsoft Word"
  ...
  try
   open file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx" add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx" then error "Owned source path mismatch"
   repaginate ownedDoc
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/quality-c280dbb9816a457d9e5025270b2926a4.pdf" file format format PDF add to recent files false
set ownedDoc to missing value
repeat with documentIndex from 1 to (count of documents)
 set d to document documentIndex
 if (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/advanced.docx") or (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-iz_8tkce/quality-c280dbb9816a457d9e5025270b2926a4.pdf") then set ownedDoc to document (name of d)
end repeat
