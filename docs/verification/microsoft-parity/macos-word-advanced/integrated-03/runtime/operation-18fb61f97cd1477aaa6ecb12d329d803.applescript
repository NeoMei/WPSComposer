...
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-aj4dmxvd/advanced.docx" file format format document default add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-aj4dmxvd/advanced.docx" then error "Owned document path mismatch"
...
set ownPicture to make new inline picture at end of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-aj4dmxvd/wpsc-rsrc:QNP5Ulby7mHPtP88.png", link to file:false, save with document:true}
...
set ownPicture to make new inline picture at end of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-aj4dmxvd/wpsc-rsrc:K9qCW0iohe-tx8yQ.png", link to file:false, save with document:true}
...
set ownedDoc to document "advanced.docx"
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-aj4dmxvd/advanced.docx" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-aj4dmxvd/advanced.docx" then error "Cleanup identity is outside this operation"
