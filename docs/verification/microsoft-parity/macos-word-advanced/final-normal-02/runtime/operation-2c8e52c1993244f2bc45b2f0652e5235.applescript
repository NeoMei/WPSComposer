...
with timeout of 162 seconds
 tell application "Microsoft Word"
  ...
  try
   open file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/advanced.docx" add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/advanced.docx" then error "Owned source path mismatch"
   repaginate ownedDoc
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/quality-37da260e581f4528b72e4d9801fa9874.pdf" file format format PDF add to recent files false
set ownedDoc to missing value
repeat with documentIndex from 1 to (count of documents)
 set d to document documentIndex
 if (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/advanced.docx") or (posix full name of d is "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/quality-37da260e581f4528b72e4d9801fa9874.pdf") then set ownedDoc to document (name of d)
end repeat
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/quality-37da260e581f4528b72e4d9801fa9874.pdf" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-u83q9ts3/advanced.docx" then error "Cleanup identity is outside this operation"
