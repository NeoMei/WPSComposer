...
save as ownedDoc file name "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-bbqgljv6/advanced.docx" file format format document default add to recent files false
set ownedDoc to document "advanced.docx"
if posix full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-bbqgljv6/advanced.docx" then error "Owned document path mismatch"
...
set p to (end of content of text object of ownedDoc) - 1
set r to create range ownedDoc start p end p
set ownPicture to make new inline picture at end of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-bbqgljv6/wpsc-rsrc:QNP5Ulby7mHPtP88.png", link to file:false, save with document:true}
...
set p to (end of content of text object of ownedDoc) - 1
set r to create range ownedDoc start p end p
set ownPicture to make new inline picture at end of text object of pictureCell with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-bbqgljv6/wpsc-rsrc:K9qCW0iohe-tx8yQ.png", link to file:false, save with document:true}
set width of ownPicture to 180.0
set height of ownPicture to 90.0
set r to text object of ownPicture
set first line indent of paragraph format of r to 0
...
set ownedDoc to document "advanced.docx"
  ...
  try
   if ownedDoc is not missing value then
    ...
    if closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-bbqgljv6/advanced.docx" and closePath is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-native-bbqgljv6/advanced.docx" then error "Cleanup identity is outside this operation"
