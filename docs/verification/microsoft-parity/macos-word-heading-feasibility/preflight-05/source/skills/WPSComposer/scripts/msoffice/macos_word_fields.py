...
def snapshot(session):
    ...
    for handle,code in tracked:
        ...
        matches=[r for r in fields if r[3]==(handle.kind if handle.kind=='REF' or handle.category=='numbering' else 'INDEX') and r[5]==identities[handle.bookmark] and r[4]==code]
