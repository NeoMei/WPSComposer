...
def seed_commands(mode):
    ...
    if mode in ('font-properties','detached-properties'):
        lines += ['set name of sourceFont to "Arial"','set ascii name of sourceFont to "Arial"',
                  ...
                  'set outside line width of border options of sourceFont to line width75 point',
...
def main(argv=None):
    ...
    parser.add_argument('--mode',choices=MODES,required=True);parser.add_argument('--output',type=Path,required=True)
