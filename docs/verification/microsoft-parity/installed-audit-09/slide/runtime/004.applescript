...
on sessionOperation()
set pdfHFS to (POSIX file "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-jthdp3c7/export-17f03af53be54fca8cdba527b041a986.pdf") as text
with timeout of 41 seconds
 tell application "Microsoft PowerPoint"
set identityCount to 0
repeat with di from 1 to (count of presentations)
 if name of presentation di is "bound-9448fc3cbeae427fb96ad0aed2a40192.pptx" then set identityCount to identityCount + 1
end repeat
if identityCount is not 1 then error "Stale or ambiguous bound presentation"
set ownedDoc to presentation "bound-9448fc3cbeae427fb96ad0aed2a40192.pptx"
if full name of ownedDoc is not "/Users/neomei/Library/Containers/com.microsoft.Powerpoint/Data/Documents/wpscomposer/session-jthdp3c7/bound-9448fc3cbeae427fb96ad0aed2a40192.pptx" then error "Bound presentation path changed"
