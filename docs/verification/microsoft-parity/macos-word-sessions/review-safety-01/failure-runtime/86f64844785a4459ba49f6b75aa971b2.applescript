...
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-l73vxx2o/document-9e9a341ac7c5479db0ae7c9a4eb6a76a.docx" then error "WPSC_STALE_DOCUMENT"
...
if insertionPoint < sourceStart then
set sourceRange to create range boundDoc start (sourceStart + sourceEnd - sourceStart) end (sourceEnd + sourceEnd - sourceStart)
end if
delete sourceRange
