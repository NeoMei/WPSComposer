...
if (posix full name of boundDoc as text) is not "/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-qszqjqf7/document.docx" then error "WPSC_STALE_DOCUMENT"
set targetRange to text object of paragraph 2 of boundDoc
set name of font object of targetRange to "Arial"
set east asian name of font object of targetRange to "Arial"
set ascii name of font object of targetRange to "Arial"
set other name of font object of targetRange to "Arial"
set complex script name of font object of targetRange to "Arial"
