...
try
set end of nativeRows to {"paragraphs", i, "style", name local of (Word style (style of targetRange) of boundDoc)}
end try
end repeat
...
try
set end of nativeRows to {"cells", cellKey, "style", name local of (Word style (style of targetRange) of boundDoc)}
end try
try
