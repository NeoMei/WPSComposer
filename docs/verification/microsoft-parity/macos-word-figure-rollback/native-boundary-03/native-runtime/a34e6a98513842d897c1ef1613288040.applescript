...
set probePicture to make new inline picture at probeInsertion with properties {file name:"/Users/neomei/Library/Containers/com.microsoft.Word/Data/tmp/wpscomposer-session-7tfd40uw/image-85deaa105f724d718f85e9e84bb1fa83.png",link to file:false,save with document:true}
...
if probeRollbackEnd is not probeMutationEnd then error ("WPSC_FIGURE_PROBE_BOUND_CHANGED expected=" & (probeMutationEnd as text) & " actual=" & (probeRollbackEnd as text) & " picture=" & (probePictureStart as text) & ":" & (probePictureEnd as text) & " suffix=" & (content of text object of probeSuffixBookmark as text))
