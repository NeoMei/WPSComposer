with timeout of 58 seconds
 tell application "/Applications/Microsoft Excel.app"
  ...
  set previousNames to name of every workbook
  repeat with existingName in previousNames
   set existingBook to workbook (contents of existingName)
  ...
  set sentinelToken to "sentinel-e9a7d3dce1ad"
  set ownedToken to "owned-e9a7d3dce1ad"
  ...
  save workbook as ownedBook filename "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/Documents/wpscomposer-parity-e9a7d3dce1ad-xlbmm8hw/native.xlsx" file format Excel XML file format
  set ownedBook to workbook "native.xlsx"
  if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/Documents/wpscomposer-parity-e9a7d3dce1ad-xlbmm8hw/native.xlsx" then error "Saved path identity mismatch"
  close ownedBook saving no
  log "stage=reopen"
  set ownedBook to open workbook workbook file name "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/Documents/wpscomposer-parity-e9a7d3dce1ad-xlbmm8hw/native.xlsx" with read only
  if full name of ownedBook is not "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/Documents/wpscomposer-parity-e9a7d3dce1ad-xlbmm8hw/native.xlsx" then error "Reopen path identity mismatch"
  ...
  log "stage=pdf"
  save workbook as ownedBook filename "/Users/neomei/Library/Containers/com.microsoft.Excel/Data/Documents/wpscomposer-parity-e9a7d3dce1ad-xlbmm8hw/native.pdf" file format PDF file format
  log "pdf_export=pass"
