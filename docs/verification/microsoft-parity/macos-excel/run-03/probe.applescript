with timeout of 58 seconds
 tell application "/Applications/Microsoft Excel.app"
  ...
  set sentinelToken to "sentinel-58d9ceb7df8e"
  set ownedToken to "owned-58d9ceb7df8e"
  ...
  save workbook as ownedBook filename "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel/run-03/native.xlsx" file format Excel XML file format
  set ownedBook to workbook "native.xlsx"
  if full name of ownedBook is not "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel/run-03/native.xlsx" then error "Saved path identity mismatch"
  close ownedBook saving no
  log "stage=reopen"
  set ownedBook to open workbook workbook file name "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel/run-03/native.xlsx" with read only
  if full name of ownedBook is not "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel/run-03/native.xlsx" then error "Reopen path identity mismatch"
  ...
  log "stage=pdf"
  save workbook as ownedBook filename "/Users/neomei/项目/codexprojects/WpsComposer/.worktrees/office-description/docs/verification/microsoft-parity/macos-excel/run-03/native.pdf" file format PDF file format
  log "pdf_export=pass"
