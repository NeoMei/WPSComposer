...
def apply_nondefault_format_commands(start, end):
    return [
        ...
        'set left indent of paragraph format of captionPreimage to 3',
        'set right indent of paragraph format of captionPreimage to 5',
...
def format_readback_commands(label, start, end):
    return [
        ...
        'first line indent of paragraph format of captionDetail,left indent of paragraph format of captionDetail,right indent of paragraph format of captionDetail,'
...
def validate_format_readback(rows, label, *, following):
    try:
        ...
        return (
            ...
            and 0 <= caption[2] < caption[3] == mark[2] < mark[3]
            and mark[3] == after[2] < after[3]
    ...
    try:
        ...
        with create_document('writer', engine='msoffice', visible=False) as session:
            ...
            assert validate_format_readback(
                report['global_format_rows'], 'global', following=' ')
            ...
            assert validate_format_readback(
                report['chapter_format_rows'], 'chapter', following='\r')
