...
def test_caption_fixture_validates_ranges_fields_centering_keep_and_suffix():
    ...
    rows=[
        ['body','Chapter\rleft 图😀(1)尾 说明😀\r 表😀[1-1]尾 True\r\rTAIL\r'],
        ['field','SEQ WPSC_FIG \\* ARABIC','1'],
        ['field','STYLEREF "标题 1" \\s','1'],
        ['field','SEQ WPSC_TAB \\* ARABIC \\s 1','1'],
        ['bookmark',m.BOOKMARKS[0],15,40,'1'],
        ['bookmark',m.BOOKMARKS[1],45,80,'1-1'],
        ['paragraph',8,27,'left 图😀(1)尾 说明😀\r',True,True,False],
        ['paragraph',27,45,' 表😀[1-1]尾 True\r',True,True,True],
        ['counts',0,0,0],
    ]
    assert m.validate_readback(rows)
